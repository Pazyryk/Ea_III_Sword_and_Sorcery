...
('BUILDING_ADEPTS_GUILD',				200,	1,					NULL,						'POLICY_GUILDS',			0,			'SPECIALIST_ADEPT',		1,					1,				'COURTHOUSE',					'BW_ATLAS_1',			63,				0		),
...
('BUILDING_CAPITAL_PALARE',				-1,		1,				'MONUMENT',		'BW_ATLAS_1',	1,				NULL,			'Util'	),
('BUILDING_CAPITAL_TYRE',				-1,		1,				'MONUMENT',		'BW_ATLAS_1',	1,				NULL,			'Util'	),
('BUILDING_CAPITAL_GERZAH',				-1,		1,				'MONUMENT',		'BW_ATLAS_1',	1,				NULL,			'Util'	),
('BUILDING_CAPITAL_HY_BREASIL',			-1,		1,				'MONUMENT',		'BW_ATLAS_1',	1,				NULL,			'Util'	),
('BUILDING_CAPITAL_PARAKHORA',			-1,		1,				'MONUMENT',		'BW_ATLAS_1',	1,				NULL,			'Util'	),
('BUILDING_CAPITAL_NETZACH',			-1,		1,				'MONUMENT',		'BW_ATLAS_1',	1,				NULL,			'Util'	),
('BUILDING_CAPITAL_YESOD',				-1,		1,				'MONUMENT',		'BW_ATLAS_1',	1,				NULL,			'Util'	),

('BUILDING_IKKOS',						-1,		1,				'MONUMENT',		'BW_ATLAS_1',	1,				NULL,			'Util'	),
('BUILDING_AB',							-1,		1,				'MONUMENT',		'BW_ATLAS_1',	1,				NULL,			'Util'	),
('BUILDING_DAGGOO',						-1,		1,				'MONUMENT',		'BW_ATLAS_1',	1,				NULL,			'Util'	),
...
('BUILDING_BREWERY',			'RESOURCE_WHEAT',		'RESOURCE_ALE'		),
...
('BUILDING_CAPITAL_YESOD',			'RESOURCE_INCENCE',		4	);
...
('BUILDING_DAGGOO',			'RESOURCE_WHALE',			'YIELD_FOOD',		1	),
('BUILDING_DAGGOO',			'RESOURCE_WHALE',			'YIELD_PRODUCTION', 1	),
('BUILDING_DAGGOO',			'RESOURCE_WHALE',			'YIELD_GOLD',		1	),
...
('BUILDING_AB',				'RESOURCE_ELEPHANT',		'YIELD_CULTURE',	3	),
('BUILDING_DAGGOO',			'RESOURCE_WHALE',			'YIELD_CULTURE',	1	);
