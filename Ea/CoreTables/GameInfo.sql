...
UPDATE GoodyHuts SET Culture = 100 WHERE Type = 'GOODY_CULTURE';
--fixinator
CREATE TABLE IDRemapper ( id INTEGER PRIMARY KEY AUTOINCREMENT, Type TEXT );
...
INSERT INTO Specialists (Type, Description, Strategy, Visible, IconAtlas, PortraitIndex, CulturePerTurn) VALUES
('SPECIALIST_CITIZEN',	'TXT_KEY_SPECIALIST_CITIZEN',		'TXT_KEY_SPECIALIST_CITIZEN_STRATEGY',		1, 'CITIZEN_ATLAS', 5, 0	),
('SPECIALIST_ARTISAN',	'TXT_KEY_EA_SPECIALIST_ARTISAN',	'TXT_KEY_EA_SPECIALIST_ARTISAN_STRATEGY',	1, 'CITIZEN_ATLAS', 4, 4	),
('SPECIALIST_SCRIBE',	'TXT_KEY_EA_SPECIALIST_SCRIBE',		'TXT_KEY_EA_SPECIALIST_SCRIBE_STRATEGY',	1, 'CITIZEN_ATLAS', 2, 0	),
('SPECIALIST_TRADER',	'TXT_KEY_EA_SPECIALIST_TRADER',		'TXT_KEY_EA_SPECIALIST_TRADER_STRATEGY',	1, 'CITIZEN_ATLAS', 3, 0	),
('SPECIALIST_SMITH',	'TXT_KEY_EA_SPECIALIST_SMITH',		'TXT_KEY_EA_SPECIALIST_SMITH_STRATEGY',		1, 'CITIZEN_ATLAS', 1, 0	),
('SPECIALIST_DISCIPLE',	'TXT_KEY_EA_SPECIALIST_DISCIPLE',	'TXT_KEY_EA_SPECIALIST_DISCIPLE_STRATEGY',	1, 'CITIZEN_ATLAS', 4, 0	),
('SPECIALIST_ADEPT',	'TXT_KEY_EA_SPECIALIST_ADEPT',		'TXT_KEY_EA_SPECIALIST_ADEPT_STRATEGY',		1, 'CITIZEN_ATLAS', 4, 0	);

INSERT INTO SpecialistYields (SpecialistType, YieldType, Yield) VALUES
('SPECIALIST_CITIZEN',	'YIELD_PRODUCTION', 1	),
('SPECIALIST_TRADER',	'YIELD_GOLD',		4	),
('SPECIALIST_SCRIBE',	'YIELD_SCIENCE',	4	),
('SPECIALIST_SMITH',	'YIELD_PRODUCTION', 4	),
('SPECIALIST_DISCIPLE',	'YIELD_FAITH',		4	),
('SPECIALIST_ADEPT',	'YIELD_FAITH',		4	);
