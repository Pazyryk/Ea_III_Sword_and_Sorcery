...
--AI
UPDATE Defines SET Value = 500 WHERE Name = 'AI_RENOUNCE_MALEFICIUM_BASE_VALUE';			--500 (EaDLL)
UPDATE Defines SET Value = 2 WHERE Name = 'AI_RENOUNCE_MALEFICIUM_PEACE_MULTIPLIER';		--2   (EaDLL)
UPDATE Defines SET Value = 100 WHERE Name = 'AI_RENOUNCE_MALEFICIUM_RECEIVER_VALUE';		--100 (EaDLL)
