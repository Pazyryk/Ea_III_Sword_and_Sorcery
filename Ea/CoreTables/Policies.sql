...
('POLICY_FOLKART',					1,		1,		'POLICY_BRANCH_TRADITION',		24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_CRAFTING',					1,		2,		'POLICY_BRANCH_TRADITION',		24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_FOLKLORE',					3,		1,		'POLICY_BRANCH_TRADITION',		24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_BARDING',					3,		2,		'POLICY_BRANCH_TRADITION',		24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
...
('POLICY_ILLUSIONISTS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
--row 1
('POLICY_WOODSMEN',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_NOMADS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_PASTORALISTS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_HUNTERS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ARCHERS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_SEAFARERS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_FARMERS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_TRADERS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_CRAFTSMEN',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_SCHOLARS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ENGINEERS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
...
('POLICY_BARDS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MISSIONARIES',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MINERS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_SMELTERS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_WAR_TECTICIANS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ARISTOCRATS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_SLAVERS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ENVOYS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
--row 2
('POLICY_FOREST_LORDS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_TUNDRA_NOMADS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_DESERT_NOMADS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ANIMAL_BREEDERS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_HORSE_TRIBES',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ELEPHANT_TAMERS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ANIMAL_MASTERS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MARKSMEN',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_CARAVANERS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_SEA_TRADERS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_SHIP_BUILDERS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_WHALERS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MERCHANTS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MILLERS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_WEAVERS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_BREWERS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_JEWELERS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_GOLD_SILVERSMITHS',		'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_PHILOSOPHERS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ASTRONOMERS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ASTRONOMERS_2',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_DIVINE_SCHOLARS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ARCANE_SCHOLARS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ZEALOTS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_POTION_MAKERS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_BAKKHEIANS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_PERFORMERS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MATHEMATICIANS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_STONEMASONS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_CIVIL_ENGINEERS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MACHINISTS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ARCHITECTS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_WEAPON_SMITHS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_WAR_STRATEGISTS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ROYALISTS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_DEEP_MINERS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_UNDERDARK_DENIZENS',		'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_SLAVE_LORDS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_DIPLOMATS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
--row 3
('POLICY_HORSELORDS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ICE_LORDS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_DESERT_LORDS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MASTER_MERCENARIES',		'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_LEVIATHAN_HUNTERS',		'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_NAVAL_ENGINEERS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_ADVANCED_AGRICULTURALISTS','POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_EXOTIC_TRADERS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_BANKERS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MASTER_MARKSMEN',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MASTER_WEAVERS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MASTER_BREWERS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_OENOLOGISTS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_THEOLOGISTS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_CRUSADERS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_DEMONOLOGISTS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_HELL_DENIZENS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MASTER_ARCANISTS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MASTER_PERFORMERS',		'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MASTER_MATHEMATICIANS',	'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MONUMENT_BUILDERS',		'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MASTER_CITY_ENGINEERS',	'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_BEASTMASTERS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_METAPHYSICISTS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_COSMOLOGISTS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_WEAPON_MASTERS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_IMPERIALISTS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_UNDERDARK_LORDS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_AMBASSADORS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' );
...
--UPDATE Policies SET MinorFriendshipDecayMod = -50 WHERE Type = 'POLICY_PATRONAGE';		--done by GameEvents.PlayerMinorFriendshipDecayMod
...
('POLICY_ALL_FULL_CIVS',				1	),	--exists for all major civs

('POLICY_USES_MANA',					1	),
('POLICY_USES_DIVINE_FAVOR',			1	),
('POLICY_IS_FALLEN',					1	),
...
UPDATE Policies SET HappinessToCulture = 50 WHERE Type = 'POLICY_EACIV_PALARE';
...
('POLICY_TUNDRA_NOMADS',		'POLICY_NOMADS'			),
('POLICY_DESERT_NOMADS',		'POLICY_NOMADS'			),
('POLICY_ANIMAL_BREEDERS',		'POLICY_PASTORALISTS'	),
('POLICY_HORSE_TRIBES',			'POLICY_PASTORALISTS'	),
('POLICY_ELEPHANT_TAMERS',		'POLICY_HUNTERS'		),
('POLICY_ANIMAL_MASTERS',		'POLICY_HUNTERS'		),
('POLICY_MARKSMEN',				'POLICY_ARCHERS'		),
('POLICY_CARAVANERS',			'POLICY_TRADERS'		),
('POLICY_SEA_TRADERS',			'POLICY_TRADERS'		),
('POLICY_SHIP_BUILDERS',		'POLICY_SEAFARERS'		),
('POLICY_MERCHANTS',			'POLICY_TRADERS'		),
('POLICY_MILLERS',				'POLICY_FARMERS'		),
('POLICY_WEAVERS',				'POLICY_CRAFTSMEN'		),
('POLICY_BREWERS',				'POLICY_CRAFTSMEN'		),
('POLICY_JEWELERS',				'POLICY_CRAFTSMEN'		),
('POLICY_GOLD_SILVERSMITHS',	'POLICY_CRAFTSMEN'		),
('POLICY_PHILOSOPHERS',			'POLICY_SCHOLARS'		),
('POLICY_ASTRONOMERS',			'POLICY_SCHOLARS'		),
('POLICY_DIVINE_SCHOLARS',		'POLICY_SCHOLARS'		),
('POLICY_ARCANE_SCHOLARS',		'POLICY_SCHOLARS'		),
('POLICY_ASTRONOMERS_2',		'POLICY_SEAFARERS'		),
('POLICY_ZEALOTS',				'POLICY_MISSIONARIES'	),
('POLICY_POTION_MAKERS',		'POLICY_HERBALISTS'		),
('POLICY_POTION_MAKERS',		'POLICY_ALCHEMISTS'		),
('POLICY_BAKKHEIANS',			'POLICY_BARDS'			),
('POLICY_PERFORMERS',			'POLICY_BARDS'			),
('POLICY_MATHEMATICIANS',		'POLICY_SCHOLARS'		),
('POLICY_STONEMASONS',			'POLICY_CRAFTSMEN'		),
('POLICY_CIVIL_ENGINEERS',		'POLICY_ENGINEERS'		),
('POLICY_MACHINISTS',			'POLICY_ENGINEERS'		),
('POLICY_ARCHITECTS',			'POLICY_ENGINEERS'		),
('POLICY_WEAPON_SMITHS',		'POLICY_SMELTERS'		),
('POLICY_WAR_STRATEGISTS',		'POLICY_WAR_TECTICIANS'	),
('POLICY_DEEP_MINERS',			'POLICY_MINERS'			),
('POLICY_UNDERDARK_DENIZENS',	'POLICY_MINERS'			),
('POLICY_ROYALISTS',			'POLICY_ARISTOCRATS'	),
('POLICY_SLAVE_LORDS',			'POLICY_SLAVERS'		),
('POLICY_DIPLOMATS',			'POLICY_ENVOYS'			),

('POLICY_HORSELORDS',			'POLICY_HORSE_TRIBES'	),
('POLICY_FOREST_LORDS',			'POLICY_WOODSMEN'		),
('POLICY_ICE_LORDS',			'POLICY_TUNDRA_NOMADS'	),
('POLICY_DESERT_LORDS',			'POLICY_DESERT_NOMADS'	),
('POLICY_MASTER_MERCENARIES',	'POLICY_MERCHANTS'		),
('POLICY_LEVIATHAN_HUNTERS',	'POLICY_WHALERS'		),
('POLICY_LEVIATHAN_HUNTERS',	'POLICY_ANIMAL_MASTERS'	),
('POLICY_NAVAL_ENGINEERS',		'POLICY_SHIP_BUILDERS'	),
('POLICY_ADVANCED_AGRICULTURALISTS','POLICY_MILLERS'	),
('POLICY_EXOTIC_TRADERS',		'POLICY_CARAVANERS'		),
('POLICY_EXOTIC_TRADERS',		'POLICY_SEA_TRADERS'	),
('POLICY_BANKERS',				'POLICY_MERCHANTS'		),
('POLICY_MASTER_MARKSMEN',		'POLICY_MARKSMEN'		),
('POLICY_MASTER_WEAVERS',		'POLICY_WEAVERS'		),
('POLICY_MASTER_BREWERS',		'POLICY_BREWERS'		),
('POLICY_OENOLOGISTS',			'POLICY_BREWERS'		),
('POLICY_THEOLOGISTS',			'POLICY_DIVINE_SCHOLARS'),
('POLICY_CRUSADERS',			'POLICY_ZEALOTS'		),
('POLICY_DEMONOLOGISTS',		'POLICY_ARCANE_SCHOLARS'),
('POLICY_HELL_DENIZENS',		'POLICY_POTION_MAKERS'	),
('POLICY_MASTER_ARCANISTS',		'POLICY_ARCANE_SCHOLARS'),
('POLICY_MASTER_PERFORMERS',	'POLICY_PERFORMERS'		),
('POLICY_MASTER_MATHEMATICIANS','POLICY_MATHEMATICIANS'	),
('POLICY_MONUMENT_BUILDERS',	'POLICY_STONEMASONS'	),
('POLICY_MASTER_CITY_ENGINEERS','POLICY_CIVIL_ENGINEERS'),
('POLICY_BEASTMASTERS',			'POLICY_ANIMAL_MASTERS'	),
('POLICY_METAPHYSICISTS',		'POLICY_PHILOSOPHERS'	),
('POLICY_COSMOLOGISTS',			'POLICY_ASTRONOMERS'	),
('POLICY_WEAPON_MASTERS',		'POLICY_WEAPON_SMITHS'	),
('POLICY_IMPERIALISTS',			'POLICY_ROYALISTS'		),
('POLICY_UNDERDARK_LORDS',		'POLICY_UNDERDARK_DENIZENS'	),
('POLICY_AMBASSADORS',			'POLICY_DIPLOMATS'		);
...
('POLICY_SCHOLASTICISM',		'BUILDINGCLASS_LIBRARY',			'YIELD_SCIENCE',	10	),
...
('POLICY_MERCHANT_NAVY',		'BUILDINGCLASS_HARBOR',				'YIELD_GOLD',		10	),
...
('POLICY_CRAFTING',					'BUILDINGCLASS_FAIR',			1	),
('POLICY_CRAFTING',					'BUILDINGCLASS_IVORYWORKS',		1	),
('POLICY_CRAFTING',					'BUILDINGCLASS_JEWELLER',		1	),
...
('POLICY_CRAFTING',					'BUILDINGCLASS_DISTILLERY',		1	),
('POLICY_THE_ARTS',					'BUILDINGCLASS_THEATRE',		2	),
('POLICY_THE_ARTS',					'BUILDINGCLASS_OPERA_HOUSE',	2	),
('POLICY_THE_ARTS',					'BUILDINGCLASS_MUSEUM',			2	),
('POLICY_THE_ARTS',					'BUILDINGCLASS_UNIVERSITY',		2	),
...
--utility
('POLICY_USES_MANA',				'IMPROVEMENT_GATHERERS_HUT',	'YIELD_FAITH',		3	),

('POLICY_USES_MANA',				'IMPROVEMENT_SRI_PADA',			'YIELD_FAITH',		2	),
('POLICY_USES_MANA',				'IMPROVEMENT_GEYSER',			'YIELD_FAITH',		5	),
('POLICY_USES_MANA',				'IMPROVEMENT_VOLCANO',			'YIELD_FAITH',		6	),
('POLICY_USES_MANA',				'IMPROVEMENT_GIBRALTAR',		'YIELD_FAITH',		2	),
('POLICY_USES_MANA',				'IMPROVEMENT_REEF',				'YIELD_FAITH',		2	),
('POLICY_USES_MANA',				'IMPROVEMENT_KILIMANJARO',		'YIELD_FAITH',		2	),
('POLICY_USES_MANA',				'IMPROVEMENT_MT_KAILASH',		'YIELD_FAITH',		2	),
('POLICY_USES_MANA',				'IMPROVEMENT_MT_SINAI',			'YIELD_FAITH',		5	),
('POLICY_USES_DIVINE_FAVOR',		'IMPROVEMENT_EL_DORADO',		'YIELD_FAITH',		6	),
('POLICY_IS_FALLEN',				'IMPROVEMENT_SOLOMONS_MINES',	'YIELD_FAITH',		6	),
...
('POLICY_FELLOWSHIP_OF_LEAVES',		'IMPROVEMENT_T_PLANTATION',		1	),
...
('POLICY_FOLKART',					'IMPROVEMENT_VINEYARD',			1	),
('POLICY_FOLKART',					'IMPROVEMENT_T_PLANTATION',		1	),
('POLICY_FOLKART',					'IMPROVEMENT_E_PLANTATION',		1	),
('POLICY_FOLKART',					'IMPROVEMENT_QUARRY',			1	);
...
('POLICY_SCHOLASTICISM',			'YIELD_SCIENCE',				10	),
('POLICY_ACADEMIC_TRADITION',		'YIELD_SCIENCE',				15	),
('POLICY_RATIONALISM',				'YIELD_SCIENCE',				15	);
