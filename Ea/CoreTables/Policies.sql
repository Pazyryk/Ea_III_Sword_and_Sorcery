...
--one-offs
('POLICY_FISHERMEN',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_MISTICS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
...
('POLICY_SMITHS',					'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_DIPLOMATS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_FAIRY_FRIENDS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
...
('POLICY_WEOPON_SMITHS',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
...
('POLICY_MASTER_POTION_MAKERS',		'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
...
('POLICY_MASTER_WAR_STRATEGISTS',	'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_IMPERIALISTS',				'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
('POLICY_IMPERIALISTS_2',			'POLICY_BRANCH_CIV_ENABLED',	24,				'POLICY_ATLAS',	'POLICY_A_ATLAS' ),
...
('POLICY_WHALERS',				'POLICY_SEAFARERS'		),
...
('POLICY_METAPHYSICISTS',		'POLICY_SCHOLARS'		),
...
('POLICY_WEOPON_SMITHS',		'POLICY_SMELTERS'		),
...
('POLICY_HELL_DENIZENS',		'POLICY_ARCANE_SCHOLARS'),
('POLICY_MASTER_ARCANISTS',		'POLICY_ARCANE_SCHOLARS'),
('POLICY_MASTER_POTION_MAKERS',	'POLICY_POTION_MAKERS'	),
...
('POLICY_COSMOLOGISTS',			'POLICY_METAPHYSICISTS'	),
('POLICY_WEAPON_MASTERS',		'POLICY_WEOPON_SMITHS'	),
('POLICY_MASTER_WAR_STRATEGISTS','POLICY_WAR_STRATEGISTS'),
('POLICY_IMPERIALISTS',			'POLICY_WAR_STRATEGISTS'),
('POLICY_IMPERIALISTS_2',		'POLICY_ROYALISTS'		),
