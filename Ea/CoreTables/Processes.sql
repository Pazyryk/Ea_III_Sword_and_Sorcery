...
SELECT 'PROCESS_WORLD_SALVATION',			'TXT_KEY_EA_PROCESS_WORLD_SALVATION',			'TXT_KEY_EA_PROCESS_WORLD_SALVATION_HELP',			'TXT_KEY_EA_PROCESS_WORLD_SALVATION_STRATEGY',			'POLICY_THEOCRACY',				'EXPANSION_UNIT_ATLAS_1',		20			UNION ALL
...
SELECT 'PROCESS_INDUSTRIAL_AGRICULTURE',	'FLAVOR_GROWTH',			5	UNION ALL
SELECT 'PROCESS_WORLD_WEAVE',				'FLAVOR_RELIGION',			5	UNION ALL
SELECT 'PROCESS_EA_BLESSINGS',				'FLAVOR_RELIGION',			5	UNION ALL
SELECT 'PROCESS_MAJOR_SPIRITS_TRIBUTE',		'FLAVOR_RELIGION',			2	UNION ALL
SELECT 'PROCESS_MAJOR_SPIRITS_TRIBUTE',		'FLAVOR_DIPLOMACY',			2	UNION ALL
SELECT 'PROCESS_FAERIES_TRIBUTE',			'FLAVOR_RELIGION',			2	UNION ALL
SELECT 'PROCESS_FAERIES_TRIBUTE',			'FLAVOR_DIPLOMACY',			2	UNION ALL
SELECT 'PROCESS_AZZANDARAS_TRIBUTE',		'FLAVOR_RELIGION',			5	UNION ALL
SELECT 'PROCESS_WORLD_SALVATION',			'FLAVOR_RELIGION',			5	UNION ALL
SELECT 'PROCESS_AHRIMANS_TRIBUTE',			'FLAVOR_RELIGION',			5	UNION ALL
SELECT 'PROCESS_WORLD_CORRUPTION',			'FLAVOR_RELIGION',			5	UNION ALL
SELECT 'PROCESS_OPPRESSION',				'FLAVOR_PRODUCTION',		5	UNION ALL
SELECT 'PROCESS_OPPRESSION',				'FLAVOR_HAPPINESS',			5	UNION ALL
SELECT 'PROCESS_TRAINING_EXERCISES',		'FLAVOR_MILITARY_TRAINING',	5	UNION ALL
SELECT 'PROCESS_RESEARCH',					'FLAVOR_SCIENCE',			5	UNION ALL
SELECT 'PROCESS_THE_ARTS',					'FLAVOR_CULTURE',			5	UNION ALL
SELECT 'PROCESS_TRADE_SURPLUS',				'FLAVOR_DIPLOMACY',			5	UNION ALL
SELECT 'PROCESS_TRADE_SURPLUS',				'FLAVOR_GOLD',				5	UNION ALL
SELECT 'PROCESS_PATRONAGE',					'FLAVOR_DIPLOMACY',			5	;
