...
('RESOURCE_NAPHTHA',		0,			'TXT_KEY_EA_RESOURCE_NAPHTHA',			'TXT_KEY_EA_CIV5_RESOURCE_NAPHTHA_TEXT',			'TXT_KEY_EA_RESOURCE_NAPHTHA_HELP',			'TECH_MINING',			'TECH_ALCHEMY',				'RESOURCECLASS_RUSH',	'ART_DEF_RESOURCE_OIL',			'ART_DEF_RESOURCE_OIL_HEAVY',		'ART_DEF_RESOURCE_OIL_WATER',		'ART_DEF_RESOURCE_OIL_HEAVY_WATER',		0,					1,				100,				3,				90,				10,			10,			100,	0,		1,			1,				'[ICON_RES_COAL]',		2,				'RESOURCE_ATLAS'			),
...
('IMPROVEMENT_FARM',			'TECH_AGRICULTURE_NO_PAN',	'YIELD_FOOD',		2 ),
('IMPROVEMENT_MINE',			'TECH_MINING_NO_PAN',		'YIELD_PRODUCTION',	2 ),
('IMPROVEMENT_LUMBERMILL',		'TECH_MILLING_NO_PAN',		'YIELD_PRODUCTION', 2 ),
...
('IMPROVEMENT_FARM',			'TECH_CROP_ROTATION_NO_PAN','YIELD_FOOD',		1 ),
('IMPROVEMENT_LUMBERMILL',		'TECH_FORESTRY_NO_PAN',		'YIELD_PRODUCTION', 1 ),
...
('IMPROVEMENT_FARM',	'TECH_IRRIGATION_NO_PAN',	'YIELD_FOOD', 1 );
