...
ALTER TABLE Features ADD COLUMN 'EaImprovement' TEXT DEFAULT NULL;			--dummy improvement added to NWs for plot yield by policy
...
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_MOUNT_ABNOAB', EaGod = 'MINOR_CIV_GOD_ABNOAB', EaImprovement = 'IMPROVEMENT_SRI_PADA' WHERE Type = 'FEATURE_SRI_PADA';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_SPRING_AVETA', EaGod = 'MINOR_CIV_GOD_AVETA', EaImprovement = 'IMPROVEMENT_FOUNTAIN_YOUTH' WHERE Type = 'FEATURE_FOUNTAIN_YOUTH';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_BORVOS_GEYSER', EaGod = 'MINOR_CIV_GOD_BORVO', EaImprovement = 'IMPROVEMENT_GEYSER' WHERE Type = 'FEATURE_GEYSER';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_LAKE_BELISAMA', EaGod = 'MINOR_CIV_GOD_BELISAMA', EaImprovement = 'IMPROVEMENT_LAKE_VICTORIA' WHERE Type = 'FEATURE_LAKE_VICTORIA';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_ELDIRS_VOLCANO', EaGod = 'MINOR_CIV_GOD_ELDIR', EaImprovement = 'IMPROVEMENT_VOLCANO' WHERE Type = 'FEATURE_VOLCANO';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_RITONAS_ROCK', EaGod = 'MINOR_CIV_GOD_RITONA', EaImprovement = 'IMPROVEMENT_GIBRALTAR' WHERE Type = 'FEATURE_GIBRALTAR';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_LI_BANS_REEF', EaGod = 'MINOR_CIV_GOD_LIBAN', EaImprovement = 'IMPROVEMENT_REEF' WHERE Type = 'FEATURE_REEF';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_MOUNT_ERECURA', EaGod = 'MINOR_CIV_GOD_ERECURA', EaImprovement = 'IMPROVEMENT_FUJI' WHERE Type = 'FEATURE_FUJI';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_MOUNT_VOSEGUS', EaGod = 'MINOR_CIV_GOD_VOSEGUS', EaImprovement = 'IMPROVEMENT_KILIMANJARO' WHERE Type = 'FEATURE_KILIMANJARO';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_MOUNT_NANTOSUELTA', EaGod = 'MINOR_CIV_GOD_NANTOSUELTA', EaImprovement = 'IMPROVEMENT_MT_KAILASH' WHERE Type = 'FEATURE_MT_KAILASH';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_DIS_PATERS_VAULT', EaGod = 'MINOR_CIV_GOD_DIS_PATER', EaImprovement = 'IMPROVEMENT_POTOSI' WHERE Type = 'FEATURE_POTOSI';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_MOUNT_NERGAL', EaGod = 'MINOR_CIV_GOD_NERGAL', EaImprovement = 'IMPROVEMENT_MT_SINAI' WHERE Type = 'FEATURE_MT_SINAI';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_WADDS_ROCK', EaGod = 'MINOR_CIV_GOD_WADD', EaImprovement = 'IMPROVEMENT_ULURU' WHERE Type = 'FEATURE_ULURU';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_ABGALS_OUTCROP', EaGod = 'MINOR_CIV_GOD_ABGAL', EaImprovement = 'IMPROVEMENT_MESA' WHERE Type = 'FEATURE_MESA';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_NESRS_BOWL', EaGod = 'MINOR_CIV_GOD_NESR', NaturalWonderHappiness = 0, EaImprovement = 'IMPROVEMENT_CRATER' WHERE Type = 'FEATURE_CRATER';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_PYRAMID_AZZANDARA', EaImprovement = 'IMPROVEMENT_EL_DORADO' WHERE Type = 'FEATURE_EL_DORADO';
UPDATE Features SET Description = 'TXT_KEY_EA_FEATURE_VAULT_AHRIMAN', NaturalWonderHappiness = -2, EaImprovement = 'IMPROVEMENT_SOLOMONS_MINES' WHERE Type = 'FEATURE_SOLOMONS_MINES';
...
--NWs (faith yields added by Policy_ImprovementYieldChanges so we have mana vs divine favor control)
('FEATURE_SRI_PADA',		'YIELD_FOOD',		3	),
('FEATURE_FOUNTAIN_YOUTH',	'YIELD_FOOD',		5	),
('FEATURE_LAKE_VICTORIA',	'YIELD_FOOD',		2	),
('FEATURE_LAKE_VICTORIA',	'YIELD_SCIENCE',	1	),
('FEATURE_LAKE_VICTORIA',	'YIELD_CULTURE',	2	),
('FEATURE_GIBRALTAR',		'YIELD_CULTURE',	3	),
('FEATURE_REEF',			'YIELD_FOOD',		3	),
('FEATURE_FUJI',			'YIELD_PRODUCTION', 2	),
('FEATURE_FUJI',			'YIELD_GOLD',		3	),
('FEATURE_KILIMANJARO',		'YIELD_PRODUCTION', 3	),
('FEATURE_MT_KAILASH',		'YIELD_PRODUCTION', 3	),
('FEATURE_POTOSI',			'YIELD_GOLD',		3	);
...
ALTER TABLE Resources ADD COLUMN 'EaClass' TEXT DEFAULT NULL;	--Animal, Plant, Earth
...
('RESOURCE_COPPER',			0,			'TXT_KEY_EA_RESOURCE_COPPER',			'TXT_KEY_EA_CIV5_RESOURCE_COPPER_TEXT',				'TXT_KEY_EA_RESOURCE_COPPER_HELP',			'TECH_MINING',			'TECH_BRONZE_WORKING',		'RESOURCECLASS_RUSH',	'ART_DEF_RESOURCE_TIN',			NULL,								'ART_DEF_RESOURCE_TIN',				NULL,									0,					1,				100,				3,				90,				10,			10,			100,	1,		1,			1,				'[ICON_RES_COPPER]',	24,				'RESOURCE_ATLAS'			),
...
UPDATE Resources SET EaClass = 'Animal' WHERE Type IN ( 'RESOURCE_BOARS', 'RESOURCE_COW', 'RESOURCE_CRAB', 'RESOURCE_DEER', 'RESOURCE_ELEPHANT', 'RESOURCE_FISH',
'RESOURCE_FUR', 'RESOURCE_HORSE', 'RESOURCE_PEARLS', 'RESOURCE_SILK', 'RESOURCE_WHALE', 'RESOURCE_WOOL');
UPDATE Resources SET EaClass = 'Plant' WHERE Type IN ( 'RESOURCE_BANANA', 'RESOURCE_BERRIES', 'RESOURCE_CITRUS', 'RESOURCE_COTTON', 'RESOURCE_DYE', 'RESOURCE_INCENSE',
'RESOURCE_MOLY', 'RESOURCE_OPIUM', 'RESOURCE_SPICES', 'RESOURCE_SUGAR', 'RESOURCE_TEA', 'RESOURCE_TOBACCO', 'RESOURCE_WHEAT', 'RESOURCE_WINE', 'RESOURCE_YEW');
UPDATE Resources SET EaClass = 'Earth' WHERE Type IN ( 'RESOURCE_COPPER', 'RESOURCE_GEMS', 'RESOURCE_GOLD', 'RESOURCE_IRON', 'RESOURCE_JADE', 'RESOURCE_MARBLE',
'RESOURCE_MITHRIL', 'RESOURCE_NAPHTHA', 'RESOURCE_QUICKSILVER', 'RESOURCE_SALT', 'RESOURCE_SILVER', 'RESOURCE_STONE');
...
--civ-restricted
('IMPROVEMENT_POLDER',			'TXT_KEY_EA_IMPROVEMENT_POLDER',			'TXT_KEY_EA_IMPROVEMENT_POLDER_PEDIA',					'ART_DEF_IMPROVEMENT_POLDER',				0,		10,			0,			0,						0,				'EXPANSION_TERRAIN_ATLAS'	),

--game mechanics
('IMPROVEMENT_BLIGHT',			'TXT_KEY_EA_BLIGHT',						'TXT_KEY_EA_BLIGHT_PEDIA',								'ART_DEF_IMPROVEMENT_BLIGHT',				0,		0,			1,			0,						25,				'TERRAIN_ATLAS'	);

--plot wonders
INSERT INTO Improvements (Type,		Description,								Civilopedia,										ArtDefineTag,								Water, PillageGold, Permanent,	DestroyedWhenPillaged,	EaBlightSafe,	CreatedByGreatPerson,	PortraitIndex,	IconAtlas								) VALUES
('IMPROVEMENT_RUINS',				'TXT_KEY_EA_RUINS',							'TXT_KEY_EA_RUINS_PEDIA',							'ART_DEF_IMPROVEMENT_CITY_RUINS',			0,		0,			1,			0,						1,				1,						39,				'TERRAIN_ATLAS'							),
('IMPROVEMENT_STANHENCG',			'TXT_KEY_EA_WONDER_STANHENCG',				'TXT_KEY_EA_WONDER_STANHENCG_PEDIA',				'ART_DEF_IMPROVEMENT_STONEHENGE',			0,		10,			1,			0,						1,				1,						2,				'BW_ATLAS_2'							),
('IMPROVEMENT_PYRAMID',				'TXT_KEY_EA_WONDER_PYRAMID',				'TXT_KEY_EA_WONDER_PYRAMID_PEDIA',					'ART_DEF_IMPROVEMENT_PYRAMID',				0,		10,			1,			0,						1,				1,						0,				'BW_ATLAS_2'							),
('IMPROVEMENT_GREAT_LIBRARY',		'TXT_KEY_EA_WONDER_GREAT_LIBRARY',			'TXT_KEY_EA_WONDER_GREAT_LIBRARY_PEDIA',			'ART_DEF_IMPROVEMENT_ACADEMY',				0,		10,			1,			0,						1,				1,						1,				'BW_ATLAS_2'							),
('IMPROVEMENT_ACADEMY_PHILOSOPHY',	'TXT_KEY_EA_WONDER_ACADEMY_PHILOSOPHY',		'TXT_KEY_EA_WONDER_ACADEMY_PHILOSOPHY_PEDIA',		'ART_DEF_IMPROVEMENT_ACADEMY',				0,		10,			1,			0,						1,				1,						1,				'BW_ATLAS_2'							),
('IMPROVEMENT_ACADEMY_LOGIC',		'TXT_KEY_EA_WONDER_ACADEMY_LOGIC',			'TXT_KEY_EA_WONDER_ACADEMY_LOGIC_PEDIA',			'ART_DEF_IMPROVEMENT_ACADEMY',				0,		10,			1,			0,						1,				1,						1,				'BW_ATLAS_2'							),
('IMPROVEMENT_ACADEMY_SEMIOTICS',	'TXT_KEY_EA_WONDER_ACADEMY_SEMIOTICS',		'TXT_KEY_EA_WONDER_ACADEMY_SEMIOTICS_PEDIA',		'ART_DEF_IMPROVEMENT_ACADEMY',				0,		10,			1,			0,						1,				1,						1,				'BW_ATLAS_2'							),
('IMPROVEMENT_ACADEMY_METAPHYSICS',	'TXT_KEY_EA_WONDER_ACADEMY_METAPHYSICS',	'TXT_KEY_EA_WONDER_ACADEMY_METAPHYSICS_PEDIA',		'ART_DEF_IMPROVEMENT_ACADEMY',				0,		10,			1,			0,						1,				1,						1,				'BW_ATLAS_2'							),
('IMPROVEMENT_ACADEMY_TRANS_THOUGHT','TXT_KEY_EA_WONDER_ACADEMY_TRANS_THOUGHT',	'TXT_KEY_EA_WONDER_ACADEMY_TRANS_THOUGHT_PEDIA',	'ART_DEF_IMPROVEMENT_ACADEMY',				0,		10,			1,			0,						1,				1,						1,				'BW_ATLAS_2'							),
('IMPROVEMENT_ARCANE_TOWER',		'TXT_KEY_EA_WONDER_ARCANE_TOWER',			'TXT_KEY_EA_WONDER_ARCANE_TOWER_PEDIA',				'ART_DEF_IMPROVEMENT_CHATEAU',				0,		10,			1,			0,						1,				1,						2,				'TERRAIN_IMPROVEMENT_ICON_ATLAS_EXP2'	),
('IMPROVEMENT_TEMPLE_AZZANDARA_1',	'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_1',		'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AZZANDARA_2',	'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_2',		'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AZZANDARA_3',	'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_3',		'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AZZANDARA_4',	'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_4',		'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AZZANDARA_5',	'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_5',		'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AZZANDARA_6',	'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_6',		'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AZZANDARA_7',	'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_7',		'TXT_KEY_EA_WONDER_TEMPLE_AZZANDARA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AHRIMAN_1',	'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_1',		'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AHRIMAN_2',	'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_2',		'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AHRIMAN_3',	'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_3',		'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AHRIMAN_4',	'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_4',		'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AHRIMAN_5',	'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_5',		'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AHRIMAN_6',	'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_6',		'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AHRIMAN_7',	'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_7',		'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AHRIMAN_8',	'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_8',		'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AHRIMAN_9',	'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_9',		'TXT_KEY_EA_WONDER_TEMPLE_AHRIMAN_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_FAGUS',		'TXT_KEY_EA_WONDER_TEMPLE_FAGUS',			'TXT_KEY_EA_WONDER_TEMPLE_FAGUS_PEDIA',				'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_ABELLIO',		'TXT_KEY_EA_WONDER_TEMPLE_ABELLIO',			'TXT_KEY_EA_WONDER_TEMPLE_ABELLIO_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_BUXENUS',		'TXT_KEY_EA_WONDER_TEMPLE_BUXENUS',			'TXT_KEY_EA_WONDER_TEMPLE_BUXENUS_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_ROBOR',		'TXT_KEY_EA_WONDER_TEMPLE_ROBOR',			'TXT_KEY_EA_WONDER_TEMPLE_ROBOR_PEDIA',				'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_ABNOAB',		'TXT_KEY_EA_WONDER_TEMPLE_ABNOAB',			'TXT_KEY_EA_WONDER_TEMPLE_ABNOAB_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_EPONA',		'TXT_KEY_EA_WONDER_TEMPLE_EPONA',			'TXT_KEY_EA_WONDER_TEMPLE_EPONA_PEDIA',				'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_ATEPOMARUS',	'TXT_KEY_EA_WONDER_TEMPLE_ATEPOMARUS',		'TXT_KEY_EA_WONDER_TEMPLE_ATEPOMARUS_PEDIA',		'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_SABAZIOS',		'TXT_KEY_EA_WONDER_TEMPLE_SABAZIOS',		'TXT_KEY_EA_WONDER_TEMPLE_SABAZIOS_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AVETA',		'TXT_KEY_EA_WONDER_TEMPLE_AVETA',			'TXT_KEY_EA_WONDER_TEMPLE_AVETA_PEDIA',				'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_CONDATIS',		'TXT_KEY_EA_WONDER_TEMPLE_CONDATIS',		'TXT_KEY_EA_WONDER_TEMPLE_CONDATIS_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_ABANDINUS',	'TXT_KEY_EA_WONDER_TEMPLE_ABANDINUS',		'TXT_KEY_EA_WONDER_TEMPLE_ABANDINUS_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_ADSULLATA',	'TXT_KEY_EA_WONDER_TEMPLE_ADSULLATA',		'TXT_KEY_EA_WONDER_TEMPLE_ADSULLATA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_ICAUNUS',		'TXT_KEY_EA_WONDER_TEMPLE_ICAUNUS',			'TXT_KEY_EA_WONDER_TEMPLE_ICAUNUS_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_BELISAMA',		'TXT_KEY_EA_WONDER_TEMPLE_BELISAMA',		'TXT_KEY_EA_WONDER_TEMPLE_BELISAMA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_CLOTA',		'TXT_KEY_EA_WONDER_TEMPLE_CLOTA',			'TXT_KEY_EA_WONDER_TEMPLE_CLOTA_PEDIA',				'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_SABRINA',		'TXT_KEY_EA_WONDER_TEMPLE_SABRINA',			'TXT_KEY_EA_WONDER_TEMPLE_SABRINA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_SEQUANA',		'TXT_KEY_EA_WONDER_TEMPLE_SEQUANA',			'TXT_KEY_EA_WONDER_TEMPLE_SEQUANA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_VERBEIA',		'TXT_KEY_EA_WONDER_TEMPLE_VERBEIA',			'TXT_KEY_EA_WONDER_TEMPLE_VERBEIA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_BORVO',		'TXT_KEY_EA_WONDER_TEMPLE_BORVO',			'TXT_KEY_EA_WONDER_TEMPLE_BORVO_PEDIA',				'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_AEGIR',		'TXT_KEY_EA_WONDER_TEMPLE_AEGIR',			'TXT_KEY_EA_WONDER_TEMPLE_AEGIR_PEDIA',				'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_BARINTHUS',	'TXT_KEY_EA_WONDER_TEMPLE_BARINTHUS',		'TXT_KEY_EA_WONDER_TEMPLE_BARINTHUS_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_LIBAN',		'TXT_KEY_EA_WONDER_TEMPLE_LIBAN',			'TXT_KEY_EA_WONDER_TEMPLE_LIBAN_PEDIA',				'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_FIMAFENG',		'TXT_KEY_EA_WONDER_TEMPLE_FIMAFENG',		'TXT_KEY_EA_WONDER_TEMPLE_FIMAFENG_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_ELDIR',		'TXT_KEY_EA_WONDER_TEMPLE_ELDIR',			'TXT_KEY_EA_WONDER_TEMPLE_ELDIR_PEDIA',				'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_RITONA',		'TXT_KEY_EA_WONDER_TEMPLE_RITONA',			'TXT_KEY_EA_WONDER_TEMPLE_RITONA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_BAKKHOS',		'TXT_KEY_EA_WONDER_TEMPLE_BAKKHOS',			'TXT_KEY_EA_WONDER_TEMPLE_BAKKHOS_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_PAN',			'TXT_KEY_EA_WONDER_TEMPLE_PAN',				'TXT_KEY_EA_WONDER_TEMPLE_PAN_PEDIA',				'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_SILENUS',		'TXT_KEY_EA_WONDER_TEMPLE_SILENUS',			'TXT_KEY_EA_WONDER_TEMPLE_SILENUS_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_ERECURA',		'TXT_KEY_EA_WONDER_TEMPLE_ERECURA',			'TXT_KEY_EA_WONDER_TEMPLE_ERECURA_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_VOSEGUS',		'TXT_KEY_EA_WONDER_TEMPLE_VOSEGUS',			'TXT_KEY_EA_WONDER_TEMPLE_VOSEGUS_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_NANTOSUELTA',	'TXT_KEY_EA_WONDER_TEMPLE_NANTOSUELTA',		'TXT_KEY_EA_WONDER_TEMPLE_NANTOSUELTA_PEDIA',		'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_DIS_PATER',	'TXT_KEY_EA_WONDER_TEMPLE_DIS_PATER',		'TXT_KEY_EA_WONDER_TEMPLE_DIS_PATER_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_NERGAL',		'TXT_KEY_EA_WONDER_TEMPLE_NERGAL',			'TXT_KEY_EA_WONDER_TEMPLE_NERGAL_PEDIA',			'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_WADD',			'TXT_KEY_EA_WONDER_TEMPLE_WADD',			'TXT_KEY_EA_WONDER_TEMPLE_WADD_PEDIA',				'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_ABGAL',		'TXT_KEY_EA_WONDER_TEMPLE_ABGAL',			'TXT_KEY_EA_WONDER_TEMPLE_ABGAL_PEDIA',				'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							),
('IMPROVEMENT_TEMPLE_NESR',			'TXT_KEY_EA_WONDER_TEMPLE_NESR',			'TXT_KEY_EA_WONDER_TEMPLE_NESR_PEDIA',				'ART_DEF_IMPROVEMENT_HOLY_SITE',			0,		10,			1,			0,						1,				1,						37,				'BW_ATLAS_1'							);


INSERT INTO Improvements (Type,		Description,	ArtDefineTag,	Water,	PillageGold, Permanent,	DestroyedWhenPillaged,	EaBlightSafe,	PortraitIndex,	IconAtlas		)
SELECT EaImprovement,				Description,	'none',			0,		0,			 1,			0,						1,				39,				'TERRAIN_ATLAS'
FROM Features WHERE EaImprovement IS NOT NULL;
--Note: Improvements with ID >= IMPROVEMENT_CRATER are not shown in plot mouseover
...
UPDATE Improvements SET RequiresFeature = 1 WHERE Type = 'IMPROVEMENT_POLDER';
...
SELECT Type, 'TERRAIN_GRASS' FROM Improvements WHERE CreatedByGreatPerson = 1 UNION ALL
SELECT Type, 'TERRAIN_PLAINS' FROM Improvements WHERE CreatedByGreatPerson = 1 UNION ALL
SELECT Type, 'TERRAIN_DESERT' FROM Improvements WHERE CreatedByGreatPerson = 1 UNION ALL
SELECT Type, 'TERRAIN_TUNDRA' FROM Improvements WHERE CreatedByGreatPerson = 1 UNION ALL
SELECT Type, 'TERRAIN_SNOW' FROM Improvements WHERE CreatedByGreatPerson = 1 ;
...
('IMPROVEMENT_POLDER',			'FEATURE_MARSH'	 );

DELETE FROM Improvement_Yields;
INSERT INTO Improvement_Yields (ImprovementType, YieldType, Yield) VALUES
('IMPROVEMENT_POLDER',			'YIELD_FOOD',		4 ),
('IMPROVEMENT_FARM',			'YIELD_FOOD',		3 ),
('IMPROVEMENT_MINE',			'YIELD_PRODUCTION',	3 ),
('IMPROVEMENT_LUMBERMILL',		'YIELD_PRODUCTION',	3 ),
...
--plot wonders
('IMPROVEMENT_STANHENCG',			'YIELD_CULTURE',	4 ),
('IMPROVEMENT_STANHENCG',			'YIELD_FAITH',		4 ),
('IMPROVEMENT_PYRAMID',				'YIELD_PRODUCTION',	4 ),
('IMPROVEMENT_PYRAMID',				'YIELD_CULTURE',	4 ),
('IMPROVEMENT_GREAT_LIBRARY',		'YIELD_SCIENCE',	4 ),
('IMPROVEMENT_GREAT_LIBRARY',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_ACADEMY_PHILOSOPHY',	'YIELD_SCIENCE',	4 ),
('IMPROVEMENT_ACADEMY_PHILOSOPHY',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_ACADEMY_LOGIC',		'YIELD_SCIENCE',	4 ),
('IMPROVEMENT_ACADEMY_LOGIC',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_ACADEMY_SEMIOTICS',	'YIELD_SCIENCE',	4 ),
('IMPROVEMENT_ACADEMY_SEMIOTICS',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_ACADEMY_METAPHYSICS',	'YIELD_SCIENCE',	4 ),
('IMPROVEMENT_ACADEMY_METAPHYSICS',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_ACADEMY_TRANS_THOUGHT','YIELD_SCIENCE',	4 ),
('IMPROVEMENT_ACADEMY_TRANS_THOUGHT','YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_1',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_1',	'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_2',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_2',	'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_3',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_3',	'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_4',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_4',	'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_5',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_5',	'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_6',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_6',	'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_7',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_AZZANDARA_7',	'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_FAGUS',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_FAGUS',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_ABELLIO',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_ABELLIO',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_BUXENUS',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_BUXENUS',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_ROBOR',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_ROBOR',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_ABNOAB',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_ABNOAB',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_EPONA',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_EPONA',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_ATEPOMARUS',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_ATEPOMARUS',	'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_SABAZIOS',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_SABAZIOS',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_AVETA',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_AVETA',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_CONDATIS',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_CONDATIS',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_ABANDINUS',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_ABANDINUS',	'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_ADSULLATA',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_ADSULLATA',	'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_ICAUNUS',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_ICAUNUS',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_BELISAMA',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_BELISAMA',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_CLOTA',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_CLOTA',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_SABRINA',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_SABRINA',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_SEQUANA',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_SEQUANA',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_VERBEIA',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_VERBEIA',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_BORVO',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_BORVO',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_AEGIR',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_AEGIR',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_BARINTHUS',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_BARINTHUS',	'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_LIBAN',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_LIBAN',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_FIMAFENG',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_FIMAFENG',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_ELDIR',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_ELDIR',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_RITONA',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_RITONA',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_BAKKHOS',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_BAKKHOS',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_PAN',			'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_PAN',			'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_SILENUS',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_SILENUS',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_ERECURA',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_ERECURA',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_VOSEGUS',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_VOSEGUS',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_NANTOSUELTA',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_NANTOSUELTA',	'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_DIS_PATER',	'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_DIS_PATER',	'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_NERGAL',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_NERGAL',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_WADD',			'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_WADD',			'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_ABGAL',		'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_ABGAL',		'YIELD_FAITH',		4 ),
('IMPROVEMENT_TEMPLE_NESR',			'YIELD_CULTURE',	4 ),
('IMPROVEMENT_TEMPLE_NESR',			'YIELD_FAITH',		4 );
...
('IMPROVEMENT_POTOSI',			'RESOURCE_GEMS'			);
...
('IMPROVEMENT_MINE_2',			'RESOURCE_QUICKSILVER',		'YIELD_SCIENCE',	1 ),
...
('IMPROVEMENT_POLDER',			'FLAVOR_GROWTH',		10),
...
('IMPROVEMENT_POLDER',			'TECH_CROP_ROTATION',		'YIELD_FOOD',		1 ),
...
('IMPROVEMENT_POLDER',	'TECH_IRRIGATION',			'YIELD_FOOD', 1 );
