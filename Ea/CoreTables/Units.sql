...
('UNIT_CROSSBOWMEN_SIDHE',		'TECH_MECHANICS',			260,	12,		12,				1,		2,		'UNITCOMBAT_ARCHER',		'DOMAIN_LAND',	'UNITAI_RANGED',		1,			1,					1,					NULL,				0,			'ART_DEF_UNIT_CROSSBOWMAN',				'UNIT_ATLAS_1',				30,				'UNIT_FLAG_ATLAS',				29,					'BIPED'			),
...
('UNIT_WARRIORS_ORC',			NULL,						120,	6,		0,				0,		2,		'UNITCOMBAT_MELEE',			'DOMAIN_LAND',	'UNITAI_ATTACK',		1,			1,					1,					NULL,				0,			'ART_DEF_UNIT_ORC_WARRIOR',				'UNIT_ATLAS_1',				3,				'UNIT_FLAG_ATLAS',				3,					'BIPED'			),
('UNIT_LIGHT_INFANTRY_ORC',		'TECH_BRONZE_WORKING',		180,	9,		0,				0,		2,		'UNITCOMBAT_MELEE',			'DOMAIN_LAND',	'UNITAI_ATTACK',		1,			1,					1,					NULL,				0,			'ART_DEF_UNIT_ORC_LT_INF',				'UNIT_ATLAS_1',				9,				'UNIT_FLAG_ATLAS',				9,					'BIPED'			),
('UNIT_MEDIUM_INFANTRY_ORC',	'TECH_IRON_WORKING',		240,	12,		0,				0,		2,		'UNITCOMBAT_MELEE',			'DOMAIN_LAND',	'UNITAI_ATTACK',		1,			1,					1,					NULL,				0,			'ART_DEF_UNIT_ORC_MED_INF',				'UNIT_ATLAS_1',				14,				'UNIT_FLAG_ATLAS',				14,					'HEAVY_BIPED'	),
('UNIT_HEAVY_INFANTRY_ORC',		'TECH_METAL_CASTING',		300,	15,		0,				0,		2,		'UNITCOMBAT_MELEE',			'DOMAIN_LAND',	'UNITAI_ATTACK',		1,			1,					1,					NULL,				0,			'ART_DEF_UNIT_ORC_HEV_INF',				'UNIT_ATLAS_1',				15,				'UNIT_FLAG_ATLAS',				15,					'HEAVY_BIPED'	),
