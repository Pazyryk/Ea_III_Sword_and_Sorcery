...
('UNIT_HORSEMEN_SIDHE',			'TECH_HORSEBACK_RIDING',	200,	9,		0,				0,		4,		'UNITCOMBAT_MOUNTED',		'DOMAIN_LAND',	'UNITAI_FAST_ATTACK',	1,			1,					1,					'TECH_WAR_HORSES',	0,			'ART_DEF_UNIT_SIDHE_HORSEMAN',			'UNIT_ATLAS_1',				17,				'UNIT_FLAG_ATLAS',				17,					'QUADRUPED'		),
('UNIT_EQUITES_SIDHE',			'TECH_STIRRUPS',			260,	12,		0,				0,		4,		'UNITCOMBAT_MOUNTED',		'DOMAIN_LAND',	'UNITAI_FAST_ATTACK',	1,			1,					1,					NULL,				0,			'ART_DEF_UNIT_SIDHE_HORSEMAN',			'UNIT_ATLAS_1',				17,				'UNIT_FLAG_ATLAS',				17,					'QUADRUPED'		),
...
('UNIT_HORSE_ARCHERS_SIDHE',	'TECH_HORSEBACK_RIDING',	200,	9,		9,				1,		4,		'UNITCOMBAT_GUN',			'DOMAIN_LAND',	'UNITAI_RANGED',		1,			1,					1,					NULL,				0,			'ART_DEF_UNIT_SIDHE_HORSE_ARCHER',		'GENGHIS_UNIT_ATLAS',		0,				'GENGHIS_UNIT_FLAG_ATLAS',		0,					'BIPED'			),
('UNIT_BOWED_CAVALRY_SIDHE',	'TECH_STIRRUPS',			260,	12,		12,				1,		4,		'UNITCOMBAT_GUN',			'DOMAIN_LAND',	'UNITAI_RANGED',		1,			1,					1,					NULL,				0,			'ART_DEF_UNIT_SIDHE_HORSE_ARCHER',		'GENGHIS_UNIT_ATLAS',		0,				'GENGHIS_UNIT_FLAG_ATLAS',		0,					'BIPED'			),
('UNIT_SAGITARII_SIDHE',		'TECH_WAR_HORSES',			260,	12,		12,				1,		4,		'UNITCOMBAT_GUN',			'DOMAIN_LAND',	'UNITAI_RANGED',		1,			1,					1,					NULL,				0,			'ART_DEF_UNIT_SIDHE_HORSE_ARCHER',		'GENGHIS_UNIT_ATLAS',		0,				'GENGHIS_UNIT_FLAG_ATLAS',		0,					'BIPED'			),
