...
SELECT 'UNIT_CARAVAN', 'UNITAI_WORKER' UNION ALL
SELECT 'UNIT_CARGO_SHIP', 'UNITAI_WORKER' UNION ALL
...
INSERT INTO Unit_Builds (UnitType, BuildType)	--see Builds in UnitControl.sql
