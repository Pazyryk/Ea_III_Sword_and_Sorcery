...
function OnChangeEvent()
	--print("PazDebug GPList OnChangeEvent")
		...
		for pSpecialistInfo in GameInfo.Specialists() do	
			...
			for pCity in pPlayer:Cities() do
				if (checkIfSpecialist(pPlayer, pSpecialistInfo, pCity)) then
					...
					if (pSpecialistInfo.Type == "SPECIALIST_ARTISAN") then
						instance = m_ArtistIM:GetInstance();
						bArtistFound = true;
					elseif (pSpecialistInfo.Type == "SPECIALIST_SMITH") then
						instance = m_EngineerIM:GetInstance();
						bEngineerFound = true;
					elseif (pSpecialistInfo.Type == "SPECIALIST_TRADER") then
						instance = m_MerchantIM:GetInstance();
						bMerchantFound = true;
					elseif (pSpecialistInfo.Type == "SPECIALIST_SCRIBE") then
						instance = m_ScientistIM:GetInstance();
						bScientistFound = true;
					end		
					--Paz end modify
