...
g_Tabs = {
	...
	["AvailableTR"] = {
		SelectHighlight = Controls.AvailableTRSelectHighlight,			--Paz: now "Open Trade Routes"
	},
	--Paz add
	["CanOpenTR"] = {
		SelectHighlight = Controls.CanOpenTRSelectHighlight,			--Paz: "Trade Routes You Can Open"
	},
	--end Paz add
	["TRWithYou"] = {
...
--Paz add
Controls.TabButtonCanOpenTR:RegisterCallback( Mouse.eLClick, function() TabSelect("CanOpenTR"); end );
--end Paz add
...
--Paz add
function RefreshCanOpenTR()
	local player = Players[Game.GetActivePlayer()]
	MapModData.bReverseOnCanCreateTradeRoute = true
	local routes = player:GetTradeRoutesAvailable()
	print("#routes = ", #routes)
...
g_Tabs["CanOpenTR"].RefreshContent = RefreshCanOpenTR
--end Paz add
