...
local bForcedInterfaceMode = false
--end Paz add
...
function( wParam, lParam )
	...
	if pHeadSelectedUnit and pHeadSelectedUnit:CanRangeStrikeAt(plotX, plotY, true, true) then
		--Paz add
		if bForcedInterfaceMode and interfaceMode == MapModData.forcedInterfaceMode then
			print("Forced interface mode has been accomplished ", interfaceMode)
...
function InputHandler( uiMsg, wParam, lParam )
	...
	if currentInterfaceModeHandler and currentInterfaceModeHandler[uiMsg] then
		...
		--Paz add
		bForcedInterfaceMode = MapModData.forcedUnitSelection ~= -1
		print("WorldView InputHandler ", bForcedInterfaceMode)
		local unit
		if bForcedInterfaceMode then
		...
		return bResult
		--end Paz add
		--Paz disabled: return currentInterfaceModeHandler[uiMsg]( wParam, lParam );
