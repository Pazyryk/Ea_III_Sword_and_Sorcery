...
local MANA_TEXTURE = "yieldatlas_128_mana.dds"
local DIVINE_FAVOR_TEXTURE = "YieldAtlas_128_Faith.dds"
--end Paz add
...
local faithTexture = MANA_TEXTURE	--Paz changed from: "YieldAtlas_128_Faith.dds"
...
function BuildYield( x, y, index )
	...
	if gT.gPlayers and iOwner ~= -1 and gT.gPlayers[iOwner].bUsesDivineFavor then
		faithTexture = DIVINE_FAVOR_TEXTURE
	else
		faithTexture = MANA_TEXTURE
	end
	--end Paz add
