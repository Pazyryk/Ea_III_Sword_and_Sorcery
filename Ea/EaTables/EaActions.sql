...
('EA_ACTION_SHRUG_OFF_INJURIES',		'TXT_KEY_EA_ACTION_SHRUG_OFF_INJURIES',	'TXT_KEY_EA_ACTION_SHRUG_OFF_INJURIES_HELP',1,		'Action',	'Warrior',		'Self',			NULL,			'EAMOD_COMBAT',			1,					1,				40,			'UNIT_ACTION_ATLAS'	),
('EA_ACTION_RESTORE_TROOPS',			'TXT_KEY_EA_ACTION_RESTORE_TROOPS',		'TXT_KEY_EA_ACTION_RESTORE_TROOPS_HELP',	1,		'Action',	'Warrior',		'OwnTroops',	NULL,			'EAMOD_LOGISTICS',		1,					1,				40,			'UNIT_ACTION_ATLAS'	),
('EA_ACTION_REPAIR_WAR_CONSTRUCTS',		'TXT_KEY_EA_ACTION_REPAIR_WAR_CONSTRUCTS','TXT_KEY_EA_ACTION_REPAIR_WAR_CONSTRUCTS_HELP',1,	'Action',	'Engineer',		'OwnConstructs',NULL,			'EAMOD_COMBAT_ENGINEERING',1,				1,				40,			'UNIT_ACTION_ATLAS'	),
('EA_ACTION_REPAIR_SHIPS',				'TXT_KEY_EA_ACTION_REPAIR_SHIPS',		'TXT_KEY_EA_ACTION_REPAIR_SHIPS_HELP',		1,		'Action',	'Engineer',		'OwnShips'	,	NULL,			'EAMOD_LOGISTICS',		1,					1,				40,			'UNIT_ACTION_ATLAS'	),
('EA_ACTION_TRAIN',						'TXT_KEY_EA_ACTION_TRAIN',				'TXT_KEY_EA_ACTION_TRAIN_HELP',				1,		'Action',	'Warrior',		'OwnTroops',	NULL,			'EAMOD_LOGISTICS',		1000,				1,				5,			'BW_ATLAS_1'	);
...
('EA_ACTION_LEARN_SPELL',				'TXT_KEY_EA_ACTION_LEARN_SPELL',		NULL,										1,		'Action',	'Thaumaturge',	NULL,			'SelfTowerTemple',NULL,			NULL,					NULL,				'Person',		1,				2,			'EXPANSION_SCEN_TECH_ATLAS'	),
...
--plot wonders
('EA_ACTION_STANHENCG',					'TXT_KEY_EA_ACTION_STANHENCG',				1,		NULL,						'Build',	100,		'WonderWorkPlot',	0,				NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_STANHENCG',			'IMPROVEMENT_STANHENCG',			'World',	'EA_WONDER_STANHENCG',			NULL,							NULL,							NULL,							NULL,						NULL,							2,			'BW_ATLAS_2'				),
...
('EA_ACTION_ACADEMY_PHILOSOPHY',		'TXT_KEY_EA_ACTION_ACADEMY_PHILOSOPHY',		1,		'TECH_PHILOSOPHY',			'Build',	100,		'WonderWorkPlot',	0,				'Sage',			NULL,		NULL,			'Not',	1,				1,			'EAMOD_SCHOLARSHIP',	25,					'Plot',			'BUILD_ACADEMY_PHILOSOPHY',	'IMPROVEMENT_ACADEMY_PHILOSOPHY',	'World',	'EA_WONDER_ACADEMY_PHILOSOPHY',	NULL,							NULL,							NULL,							NULL,						NULL,							1,			'BW_ATLAS_2'				),
('EA_ACTION_ACADEMY_LOGIC',				'TXT_KEY_EA_ACTION_ACADEMY_LOGIC',			1,		'TECH_LOGIC',				'Build',	100,		'WonderWorkPlot',	0,				'Sage',			NULL,		NULL,			'Not',	1,				1,			'EAMOD_SCHOLARSHIP',	25,					'Plot',			'BUILD_ACADEMY_LOGIC',		'IMPROVEMENT_ACADEMY_LOGIC',		'World',	'EA_WONDER_ACADEMY_LOGIC',		NULL,							NULL,							NULL,							NULL,						NULL,							1,			'BW_ATLAS_2'				),
('EA_ACTION_ACADEMY_SEMIOTICS',			'TXT_KEY_EA_ACTION_ACADEMY_SEMIOTICS',		1,		'TECH_SEMIOTICS',			'Build',	100,		'WonderWorkPlot',	0,				'Sage',			NULL,		NULL,			'Not',	1,				1,			'EAMOD_SCHOLARSHIP',	25,					'Plot',			'BUILD_ACADEMY_SEMIOTICS',	'IMPROVEMENT_ACADEMY_SEMIOTICS',	'World',	'EA_WONDER_ACADEMY_SEMIOTICS',	NULL,							NULL,							NULL,							NULL,						NULL,							1,			'BW_ATLAS_2'				),
('EA_ACTION_ACADEMY_METAPHYSICS',		'TXT_KEY_EA_ACTION_ACADEMY_METAPHYSICS',	1,		'TECH_METAPHYSICS',			'Build',	100,		'WonderWorkPlot',	0,				'Sage',			NULL,		NULL,			'Not',	1,				1,			'EAMOD_SCHOLARSHIP',	25,					'Plot',			'BUILD_ACADEMY_METAPHYSICS','IMPROVEMENT_ACADEMY_METAPHYSICS',	'World',	'EA_WONDER_ACADEMY_METAPHYSICS',NULL,							NULL,							NULL,							NULL,						NULL,							1,			'BW_ATLAS_2'				),
('EA_ACTION_ACADEMY_TRANS_THOUGHT',		'TXT_KEY_EA_ACTION_ACADEMY_TRANS_THOUGHT',	1,		'TECH_TRANSCENDENTAL_THOUGHT','Build',	100,		'WonderWorkPlot',	0,				'Sage',			NULL,		NULL,			'Not',	1,				1,			'EAMOD_SCHOLARSHIP',	25,					'Plot',			'BUILD_ACADEMY_TRANS_THOUGHT','IMPROVEMENT_ACADEMY_TRANS_THOUGHT','World',	'EA_WONDER_ACADEMY_TRANS_THOUGHT',NULL,							NULL,							NULL,							NULL,						NULL,							1,			'BW_ATLAS_2'				),
...
('EA_ACTION_TEMPLE_AZZANDARA_1',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_1',		1,		'TECH_DIVINE_LITURGY',		'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Priest',	'Paladin',		'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_1',	'IMPROVEMENT_TEMPLE_AZZANDARA_1',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_1',	NULL,							NULL,							'RELIGION_AZZANDARAYASNA',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AZZANDARA_2',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_2',		1,		'TECH_DIVINE_VITALISM',		'Build',	100,		'WonderWorkPlot',	2000,			NULL,			'Priest',	'Paladin',		'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_2',	'IMPROVEMENT_TEMPLE_AZZANDARA_2',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_2',	NULL,							'EA_WONDER_TEMPLE_AZZANDARA_1',	'RELIGION_AZZANDARAYASNA',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AZZANDARA_3',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_3',		1,		'TECH_DIVINE_ESSENCE',		'Build',	100,		'WonderWorkPlot',	3000,			NULL,			'Priest',	'Paladin',		'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_3',	'IMPROVEMENT_TEMPLE_AZZANDARA_3',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_3',	NULL,							'EA_WONDER_TEMPLE_AZZANDARA_2',	'RELIGION_AZZANDARAYASNA',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AZZANDARA_4',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_4',		1,		'TECH_HEAVENLY_CYCLES',		'Build',	100,		'WonderWorkPlot',	5000,			NULL,			'Priest',	'Paladin',		'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_4',	'IMPROVEMENT_TEMPLE_AZZANDARA_4',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_4',	NULL,							'EA_WONDER_TEMPLE_AZZANDARA_3',	'RELIGION_AZZANDARAYASNA',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AZZANDARA_5',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_5',		1,		'TECH_CELESTIAL_KNOWLEDGE',	'Build',	100,		'WonderWorkPlot',	8000,			NULL,			'Priest',	'Paladin',		'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_5',	'IMPROVEMENT_TEMPLE_AZZANDARA_5',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_5',	NULL,							'EA_WONDER_TEMPLE_AZZANDARA_4',	'RELIGION_AZZANDARAYASNA',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AZZANDARA_6',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_6',		1,		'TECH_DIVINE_INTERVENTION',	'Build',	100,		'WonderWorkPlot',	9000,			NULL,			'Priest',	'Paladin',		'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_6',	'IMPROVEMENT_TEMPLE_AZZANDARA_6',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_6',	NULL,							'EA_WONDER_TEMPLE_AZZANDARA_5',	'RELIGION_AZZANDARAYASNA',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AZZANDARA_7',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_7',		1,		'TECH_KNOWLEDGE_OF_HEAVEN',	'Build',	100,		'WonderWorkPlot',	10000,			NULL,			'Priest',	'Paladin',		'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_7',	'IMPROVEMENT_TEMPLE_AZZANDARA_7',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_7',	NULL,							'EA_WONDER_TEMPLE_AZZANDARA_6',	'RELIGION_AZZANDARAYASNA',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AHRIMAN_1',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_1',		1,		'TECH_MALEFICIUM',			'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'FallenPriest','Eidolon',	'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_1',	'IMPROVEMENT_TEMPLE_AHRIMAN_1',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_1',	NULL,							NULL,							'RELIGION_ANRA',				NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AHRIMAN_2',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_2',		1,		'TECH_REANIMATION',			'Build',	100,		'WonderWorkPlot',	2000,			NULL,			'FallenPriest','Eidolon',	'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_2',	'IMPROVEMENT_TEMPLE_AHRIMAN_2',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_2',	NULL,							'EA_WONDER_TEMPLE_AHRIMAN_1',	'RELIGION_ANRA',				NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AHRIMAN_3',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_3',		1,		'TECH_SORCERY',				'Build',	100,		'WonderWorkPlot',	3000,			NULL,			'FallenPriest','Eidolon',	'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_3',	'IMPROVEMENT_TEMPLE_AHRIMAN_3',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_3',	NULL,							'EA_WONDER_TEMPLE_AHRIMAN_2',	'RELIGION_ANRA',				NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AHRIMAN_4',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_4',		1,		'TECH_NECROMANCY',			'Build',	100,		'WonderWorkPlot',	5000,			NULL,			'FallenPriest','Eidolon',	'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_4',	'IMPROVEMENT_TEMPLE_AHRIMAN_4',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_4',	NULL,							'EA_WONDER_TEMPLE_AHRIMAN_3',	'RELIGION_ANRA',				NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AHRIMAN_5',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_5',		1,		'TECH_SUMMONING',			'Build',	100,		'WonderWorkPlot',	5000,			NULL,			'FallenPriest','Eidolon',	'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_5',	'IMPROVEMENT_TEMPLE_AHRIMAN_5',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_5',	NULL,							'EA_WONDER_TEMPLE_AHRIMAN_4',	'RELIGION_ANRA',				NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AHRIMAN_6',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_6',		1,		'TECH_SOUL_BINDING',		'Build',	100,		'WonderWorkPlot',	8000,			NULL,			'FallenPriest','Eidolon',	'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_6',	'IMPROVEMENT_TEMPLE_AHRIMAN_6',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_6',	NULL,							'EA_WONDER_TEMPLE_AHRIMAN_5',	'RELIGION_ANRA',				NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AHRIMAN_7',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_7',		1,		'TECH_INVOCATION',			'Build',	100,		'WonderWorkPlot',	8000,			NULL,			'FallenPriest','Eidolon',	'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_7',	'IMPROVEMENT_TEMPLE_AHRIMAN_7',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_7',	NULL,							'EA_WONDER_TEMPLE_AHRIMAN_6',	'RELIGION_ANRA',				NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AHRIMAN_8',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_8',		1,		'TECH_BREACH',				'Build',	100,		'WonderWorkPlot',	9000,			NULL,			'FallenPriest','Eidolon',	'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_8',	'IMPROVEMENT_TEMPLE_AHRIMAN_8',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_8',	NULL,							'EA_WONDER_TEMPLE_AHRIMAN_7',	'RELIGION_ANRA',				NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AHRIMAN_9',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_9',		1,		'TECH_ARMAGEDDON_RITUALS',	'Build',	100,		'WonderWorkPlot',	10000,			NULL,			'FallenPriest','Eidolon',	'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_9',	'IMPROVEMENT_TEMPLE_AHRIMAN_9',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_9',	NULL,							'EA_WONDER_TEMPLE_AHRIMAN_8',	'RELIGION_ANRA',				NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_FAGUS',				'TXT_KEY_EA_ACTION_TEMPLE_FAGUS',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_FAGUS',		'IMPROVEMENT_TEMPLE_FAGUS',			'World',	'EA_WONDER_TEMPLE_FAGUS',		'MINOR_CIV_GOD_FAGUS',			NULL,							'RELIGION_CULT_OF_LEAVES',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_ABELLIO',			'TXT_KEY_EA_ACTION_TEMPLE_ABELLIO',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_ABELLIO',		'IMPROVEMENT_TEMPLE_ABELLIO',		'World',	'EA_WONDER_TEMPLE_ABELLIO',		'MINOR_CIV_GOD_ABELLIO',		NULL,							'RELIGION_CULT_OF_LEAVES',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_BUXENUS',			'TXT_KEY_EA_ACTION_TEMPLE_BUXENUS',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_BUXENUS',		'IMPROVEMENT_TEMPLE_BUXENUS',		'World',	'EA_WONDER_TEMPLE_BUXENUS',		'MINOR_CIV_GOD_BUXENUS',		NULL,							'RELIGION_CULT_OF_LEAVES',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_ROBOR',				'TXT_KEY_EA_ACTION_TEMPLE_ROBOR',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_ROBOR',		'IMPROVEMENT_TEMPLE_ROBOR',			'World',	'EA_WONDER_TEMPLE_ROBOR',		'MINOR_CIV_GOD_ROBOR',			NULL,							'RELIGION_CULT_OF_LEAVES',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_ABNOAB',				'TXT_KEY_EA_ACTION_TEMPLE_ABNOAB',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_ABNOAB',		'IMPROVEMENT_TEMPLE_ABNOAB',		'World',	'EA_WONDER_TEMPLE_ABNOAB',		'MINOR_CIV_GOD_ABNOAB',			NULL,							'RELIGION_CULT_OF_LEAVES',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_EPONA',				'TXT_KEY_EA_ACTION_TEMPLE_EPONA',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_EPONA',		'IMPROVEMENT_TEMPLE_EPONA',			'World',	'EA_WONDER_TEMPLE_EPONA',		'MINOR_CIV_GOD_EPONA',			NULL,							'RELIGION_CULT_OF_EPONA',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_ATEPOMARUS',			'TXT_KEY_EA_ACTION_TEMPLE_ATEPOMARUS',		1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_ATEPOMARUS',	'IMPROVEMENT_TEMPLE_ATEPOMARUS',	'World',	'EA_WONDER_TEMPLE_ATEPOMARUS',	'MINOR_CIV_GOD_ATEPOMARUS',		NULL,							'RELIGION_CULT_OF_EPONA',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_SABAZIOS',			'TXT_KEY_EA_ACTION_TEMPLE_SABAZIOS',		1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_SABAZIOS',	'IMPROVEMENT_TEMPLE_SABAZIOS',		'World',	'EA_WONDER_TEMPLE_SABAZIOS',	'MINOR_CIV_GOD_SABAZIOS',		NULL,							'RELIGION_CULT_OF_EPONA',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AVETA',				'TXT_KEY_EA_ACTION_TEMPLE_AVETA',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AVETA',		'IMPROVEMENT_TEMPLE_AVETA',			'World',	'EA_WONDER_TEMPLE_AVETA',		'MINOR_CIV_GOD_AVETA',			NULL,							'RELIGION_CULT_OF_ABZU',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_CONDATIS',			'TXT_KEY_EA_ACTION_TEMPLE_CONDATIS',		1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_CONDATIS',	'IMPROVEMENT_TEMPLE_CONDATIS',		'World',	'EA_WONDER_TEMPLE_CONDATIS',	'MINOR_CIV_GOD_CONDATIS',		NULL,							'RELIGION_CULT_OF_ABZU',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_ABANDINUS',			'TXT_KEY_EA_ACTION_TEMPLE_ABANDINUS',		1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_ABANDINUS',	'IMPROVEMENT_TEMPLE_ABANDINUS',		'World',	'EA_WONDER_TEMPLE_ABANDINUS',	'MINOR_CIV_GOD_ABANDINUS',		NULL,							'RELIGION_CULT_OF_ABZU',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_ADSULLATA',			'TXT_KEY_EA_ACTION_TEMPLE_ADSULLATA',		1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_ADSULLATA',	'IMPROVEMENT_TEMPLE_ADSULLATA',		'World',	'EA_WONDER_TEMPLE_ADSULLATA',	'MINOR_CIV_GOD_ADSULLATA',		NULL,							'RELIGION_CULT_OF_ABZU',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_ICAUNUS',			'TXT_KEY_EA_ACTION_TEMPLE_ICAUNUS',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_ICAUNUS',		'IMPROVEMENT_TEMPLE_ICAUNUS',		'World',	'EA_WONDER_TEMPLE_ICAUNUS',		'MINOR_CIV_GOD_ICAUNUS',		NULL,							'RELIGION_CULT_OF_ABZU',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_BELISAMA',			'TXT_KEY_EA_ACTION_TEMPLE_BELISAMA',		1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_BELISAMA',	'IMPROVEMENT_TEMPLE_BELISAMA',		'World',	'EA_WONDER_TEMPLE_BELISAMA',	'MINOR_CIV_GOD_BELISAMA',		NULL,							'RELIGION_CULT_OF_ABZU',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_CLOTA',				'TXT_KEY_EA_ACTION_TEMPLE_CLOTA',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_CLOTA',		'IMPROVEMENT_TEMPLE_CLOTA',			'World',	'EA_WONDER_TEMPLE_CLOTA',		'MINOR_CIV_GOD_CLOTA',			NULL,							'RELIGION_CULT_OF_ABZU',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_SABRINA',			'TXT_KEY_EA_ACTION_TEMPLE_SABRINA',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_SABRINA',		'IMPROVEMENT_TEMPLE_SABRINA',		'World',	'EA_WONDER_TEMPLE_SABRINA',		'MINOR_CIV_GOD_SABRINA',		NULL,							'RELIGION_CULT_OF_ABZU',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_SEQUANA',			'TXT_KEY_EA_ACTION_TEMPLE_SEQUANA',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_SEQUANA',		'IMPROVEMENT_TEMPLE_SEQUANA',		'World',	'EA_WONDER_TEMPLE_SEQUANA',		'MINOR_CIV_GOD_SEQUANA',		NULL,							'RELIGION_CULT_OF_ABZU',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_VERBEIA',			'TXT_KEY_EA_ACTION_TEMPLE_VERBEIA',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_VERBEIA',		'IMPROVEMENT_TEMPLE_VERBEIA',		'World',	'EA_WONDER_TEMPLE_VERBEIA',		'MINOR_CIV_GOD_VERBEIA',		NULL,							'RELIGION_CULT_OF_ABZU',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_BORVO',				'TXT_KEY_EA_ACTION_TEMPLE_BORVO',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_BORVO',		'IMPROVEMENT_TEMPLE_BORVO',			'World',	'EA_WONDER_TEMPLE_BORVO',		'MINOR_CIV_GOD_BORVO',			NULL,							'RELIGION_CULT_OF_ABZU',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_AEGIR',				'TXT_KEY_EA_ACTION_TEMPLE_AEGIR',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AEGIR',		'IMPROVEMENT_TEMPLE_AEGIR',			'World',	'EA_WONDER_TEMPLE_AEGIR',		'MINOR_CIV_GOD_AEGIR',			NULL,							'RELIGION_CULT_OF_AEGIR',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_BARINTHUS',			'TXT_KEY_EA_ACTION_TEMPLE_BARINTHUS',		1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_BARINTHUS',	'IMPROVEMENT_TEMPLE_BARINTHUS',		'World',	'EA_WONDER_TEMPLE_BARINTHUS',	'MINOR_CIV_GOD_BARINTHUS',		NULL,							'RELIGION_CULT_OF_AEGIR',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_LIBAN',				'TXT_KEY_EA_ACTION_TEMPLE_LIBAN',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_LIBAN',		'IMPROVEMENT_TEMPLE_LIBAN',			'World',	'EA_WONDER_TEMPLE_LIBAN',		'MINOR_CIV_GOD_LIBAN',			NULL,							'RELIGION_CULT_OF_AEGIR',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_FIMAFENG',			'TXT_KEY_EA_ACTION_TEMPLE_FIMAFENG',		1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_FIMAFENG',	'IMPROVEMENT_TEMPLE_FIMAFENG',		'World',	'EA_WONDER_TEMPLE_FIMAFENG',	'MINOR_CIV_GOD_FIMAFENG',		NULL,							'RELIGION_CULT_OF_AEGIR',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_ELDIR',				'TXT_KEY_EA_ACTION_TEMPLE_ELDIR',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_ELDIR',		'IMPROVEMENT_TEMPLE_ELDIR',			'World',	'EA_WONDER_TEMPLE_ELDIR',		'MINOR_CIV_GOD_ELDIR',			NULL,							'RELIGION_CULT_OF_AEGIR',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_RITONA',				'TXT_KEY_EA_ACTION_TEMPLE_RITONA',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_RITONA',		'IMPROVEMENT_TEMPLE_RITONA',		'World',	'EA_WONDER_TEMPLE_RITONA',		'MINOR_CIV_GOD_RITONA',			NULL,							'RELIGION_CULT_OF_AEGIR',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_BAKKHOS',			'TXT_KEY_EA_ACTION_TEMPLE_BAKKHOS',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_BAKKHOS',		'IMPROVEMENT_TEMPLE_BAKKHOS',		'World',	'EA_WONDER_TEMPLE_BAKKHOS',		'MINOR_CIV_GOD_BAKKHOS',		NULL,							'RELIGION_CULT_OF_BAKKHEIA',	NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_PAN',				'TXT_KEY_EA_ACTION_TEMPLE_PAN',				1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_PAN',			'IMPROVEMENT_TEMPLE_PAN',			'World',	'EA_WONDER_TEMPLE_PAN',			'MINOR_CIV_GOD_PAN',			NULL,							'RELIGION_CULT_OF_BAKKHEIA',	NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_SILENUS',			'TXT_KEY_EA_ACTION_TEMPLE_SILENUS',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_SILENUS',		'IMPROVEMENT_TEMPLE_SILENUS',		'World',	'EA_WONDER_TEMPLE_SILENUS',		'MINOR_CIV_GOD_SILENUS',		NULL,							'RELIGION_CULT_OF_BAKKHEIA',	NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_ERECURA',			'TXT_KEY_EA_ACTION_TEMPLE_ERECURA',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_ERECURA',		'IMPROVEMENT_TEMPLE_ERECURA',		'World',	'EA_WONDER_TEMPLE_ERECURA',		'MINOR_CIV_GOD_ERECURA',		NULL,							'RELIGION_CULT_OF_PLOUTON',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_VOSEGUS',			'TXT_KEY_EA_ACTION_TEMPLE_VOSEGUS',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_VOSEGUS',		'IMPROVEMENT_TEMPLE_VOSEGUS',		'World',	'EA_WONDER_TEMPLE_VOSEGUS',		'MINOR_CIV_GOD_VOSEGUS',		NULL,							'RELIGION_CULT_OF_PLOUTON',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_NANTOSUELTA',		'TXT_KEY_EA_ACTION_TEMPLE_NANTOSUELTA',		1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_NANTOSUELTA',	'IMPROVEMENT_TEMPLE_NANTOSUELTA',	'World',	'EA_WONDER_TEMPLE_NANTOSUELTA',	'MINOR_CIV_GOD_NANTOSUELTA',	NULL,							'RELIGION_CULT_OF_PLOUTON',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_DIS_PATER',			'TXT_KEY_EA_ACTION_TEMPLE_DIS_PATER',		1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_DIS_PATER',	'IMPROVEMENT_TEMPLE_DIS_PATER',		'World',	'EA_WONDER_TEMPLE_DIS_PATER',	'MINOR_CIV_GOD_DIS_PATER',		NULL,							'RELIGION_CULT_OF_PLOUTON',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_NERGAL',				'TXT_KEY_EA_ACTION_TEMPLE_NERGAL',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_NERGAL',		'IMPROVEMENT_TEMPLE_NERGAL',		'World',	'EA_WONDER_TEMPLE_NERGAL',		'MINOR_CIV_GOD_NERGAL',			NULL,							'RELIGION_CULT_OF_CAHRA',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_WADD',				'TXT_KEY_EA_ACTION_TEMPLE_WADD',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_WADD',		'IMPROVEMENT_TEMPLE_WADD',			'World',	'EA_WONDER_TEMPLE_WADD',		'MINOR_CIV_GOD_WADD',			NULL,							'RELIGION_CULT_OF_CAHRA',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_ABGAL',				'TXT_KEY_EA_ACTION_TEMPLE_ABGAL',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_ABGAL',		'IMPROVEMENT_TEMPLE_ABGAL',			'World',	'EA_WONDER_TEMPLE_ABGAL',		'MINOR_CIV_GOD_ABGAL',			NULL,							'RELIGION_CULT_OF_CAHRA',		NULL,						NULL,							37,			'BW_ATLAS_1'				),
('EA_ACTION_TEMPLE_NESR',				'TXT_KEY_EA_ACTION_TEMPLE_NESR',			1,		NULL,						'Build',	100,		'WonderWorkPlot',	1000,			NULL,			'Druid',	NULL,			'Not',	1,				1,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_NESR',		'IMPROVEMENT_TEMPLE_NESR',			'World',	'EA_WONDER_TEMPLE_NESR',		'MINOR_CIV_GOD_NESR',			NULL,							'RELIGION_CULT_OF_CAHRA',		NULL,						NULL,							37,			'BW_ATLAS_1'				);
...
--Other GP builds
INSERT INTO EaActions (Type,			Description,							GPOnly,	UIType,		TechReq,			PolicyReq,				FinishXP,	AITarget,			GPClass,	City,		GPModType1,				TurnsToComplete,	ProgressHolder,	HumanOnlySound,			PlayAnywhereSound,					IconIndex,	IconAtlas					) VALUES
('EA_ACTION_LAND_TRADE_ROUTE',			'TXT_KEY_EA_ACTION_LAND_TRADE_ROUTE',	1,		'Action',	'TECH_CURRENCY',	NULL,					25,			'LandTradeCities',	'Merchant',	'Any',		NULL,					8,					'CityCiv',		'AS2D_BUILD_UNIT',		NULL,								0,			'UNIT_ACTION_ATLAS_TRADE'	),
('EA_ACTION_SEA_TRADE_ROUTE',			'TXT_KEY_EA_ACTION_SEA_TRADE_ROUTE',	1,		'Action',	'TECH_SAILING',		NULL,					25,			'SeaTradeCities',	'Merchant',	'Any',		NULL,					8,					'CityCiv',		'AS2D_BUILD_UNIT',		NULL,								0,			'UNIT_ACTION_ATLAS_TRADE'	),
('EA_ACTION_TRADE_MISSION',				'TXT_KEY_EA_ACTION_TRADE_MISSION',		1,		'Action',	NULL,				'POLICY_FREE_TRADE',	100,		'ForeignCapitals',	'Merchant',	'Foreign',	'EAMOD_TRADE',			25,					'CityCiv',		'AS2D_BUILD_UNIT',		NULL,								17,			'TECH_ATLAS_1'				);
...
('EA_ACTION_PROSELYTIZE',				'TXT_KEY_EA_ACTION_PROSELYTIZE',		1,		'Action',	'RELIGION_AZZANDARAYASNA',	25,			'AzzandaraSpread',	NULL,		'Priest',		NULL,							'Any',		'EAMOD_PROSELYTISM',	8,					'City',			NULL,					'AS2D_EVENT_NOTIFICATION_GOOD',		1,			'EXPANSION_UNIT_ACTION_ATLAS'	),
('EA_ACTION_ANTIPROSELYTIZE',			'TXT_KEY_EA_ACTION_PROSELYTIZE',		1,		'Action',	'RELIGION_ANRA',			25,			'AnraSpread',		NULL,		'FallenPriest',	NULL,							'Any',		'EAMOD_PROSELYTISM',	8,					'City',			NULL,					'AS2D_EVENT_NOTIFICATION_VERY_BAD',	1,			'EXPANSION_UNIT_ACTION_ATLAS'	),
('EA_ACTION_RITUAL_LEAVES',				'TXT_KEY_EA_ACTION_RITUAL_LEAVES',		1,		'Spell',	'RELIGION_THE_WEAVE_OF_EA',	25,			'AllCities',		NULL,		'Druid',		'RELIGION_CULT_OF_LEAVES',		'Any',		'EAMOD_DEVOTION',		8,					'City',			NULL,					'AS2D_EVENT_NOTIFICATION_GOOD',		3,			'EA_RELIGION_ATLAS'				),
('EA_ACTION_RITUAL_CLEANSING',			'TXT_KEY_EA_ACTION_RITUAL_CLEANSING',	1,		'Spell',	'RELIGION_THE_WEAVE_OF_EA',	25,			'AllCities',		NULL,		'Druid',		'RELIGION_CULT_OF_ABZU',		'Any',		'EAMOD_DEVOTION',		8,					'City',			NULL,					'AS2D_EVENT_NOTIFICATION_GOOD',		6,			'EA_RELIGION_ATLAS'				),
('EA_ACTION_RITUAL_AEGIR',				'TXT_KEY_EA_ACTION_RITUAL_AEGIR',		1,		'Spell',	'RELIGION_THE_WEAVE_OF_EA',	25,			'AllCities',		NULL,		'Druid',		'RELIGION_CULT_OF_AEGIR',		'Any',		'EAMOD_DEVOTION',		8,					'City',			NULL,					'AS2D_EVENT_NOTIFICATION_GOOD',		7,			'EA_RELIGION_ATLAS'				),
('EA_ACTION_RITUAL_STONES',				'TXT_KEY_EA_ACTION_RITUAL_STONES',		1,		'Spell',	'RELIGION_THE_WEAVE_OF_EA',	25,			'AllCities',		NULL,		'Druid',		'RELIGION_CULT_OF_PLOUTON',		'Any',		'EAMOD_DEVOTION',		8,					'City',			NULL,					'AS2D_EVENT_NOTIFICATION_GOOD',		8,			'EA_RELIGION_ATLAS'				),
('EA_ACTION_RITUAL_DESICCATION',		'TXT_KEY_EA_ACTION_RITUAL_DESICCATION',	1,		'Spell',	'RELIGION_THE_WEAVE_OF_EA',	25,			'AllCities',		NULL,		'Druid',		'RELIGION_CULT_OF_CAHRA',		'Any',		'EAMOD_DEVOTION',		8,					'City',			NULL,					'AS2D_EVENT_NOTIFICATION_GOOD',		9,			'EA_RELIGION_ATLAS'				),
('EA_ACTION_RITUAL_EQUUS',				'TXT_KEY_EA_ACTION_RITUAL_EQUUS',		1,		'Spell',	'RELIGION_THE_WEAVE_OF_EA',	25,			'AllCities',		NULL,		'Druid',		'RELIGION_CULT_OF_EPONA',		'Any',		'EAMOD_DEVOTION',		8,					'City',			NULL,					'AS2D_EVENT_NOTIFICATION_GOOD',		5,			'EA_RELIGION_ATLAS'				),
('EA_ACTION_RITUAL_BAKKHEIA',			'TXT_KEY_EA_ACTION_RITUAL_BAKKHEIA',	1,		'Spell',	'RELIGION_THE_WEAVE_OF_EA',	25,			'AllCities',		NULL,		'Druid',		'RELIGION_CULT_OF_BAKKHEIA',	'Any',		'EAMOD_DEVOTION',		8,					'City',			NULL,					'AS2D_EVENT_NOTIFICATION_GOOD',		4,			'EA_RELIGION_ATLAS'				);
...
('EA_SPELL_SCRYING',					'Arcane',	'EAMOD_DIVINATION',		'TECH_THAUMATURGY',				NULL,	NULL,				NULL,			2,					0,			1,				0,			'EA_SPELLS_ATLAS'	),
...
('EA_SPELL_KNOW_WORLD',					'Arcane',	'EAMOD_DIVINATION',		'TECH_TRANSCENDENTAL_THOUGHT',	NULL,	NULL,				NULL,			1,					0,			1,				0,			'EA_SPELLS_ATLAS'	),
...
('EA_SPELL_BLIGHT',						'Arcane',	'EAMOD_TRANSMUTATION',	'TECH_SORCERY',					'Not',	'TowerToWide',		NULL,			3,					0,			1,				0,			'EA_SPELLS_ATLAS'	),
('EA_SPELL_BURNING_HANDS',				'Arcane',	'EAMOD_TRANSMUTATION',	'TECH_SORCERY',					NULL,	NULL,				'Any',			1,					0,			NULL,			0,			'EA_SPELLS_ATLAS'	),

('EA_SPELL_HEX',						'Arcane',	'EAMOD_CONJURATION',	'TECH_MALEFICIUM',				NULL,	NULL,				'Any',			1,					0,			1,				0,			'EA_SPELLS_ATLAS'	),
('EA_SPELL_MAGE_SWORD',					'Arcane',	'EAMOD_CONJURATION',	'TECH_EVOCATION',				NULL,	NULL,				NULL,			1,					0,			1,				0,			'EA_SPELLS_ATLAS'	),
('EA_SPELL_MAGIC_MISSILE',				'Arcane',	'EAMOD_CONJURATION',	'TECH_CONJURATION',				NULL,	NULL,				'Any',			1,					0,			NULL,			0,			'EA_SPELLS_ATLAS'	),
...
('EA_SPELL_SUMMON_ABYSSAL_CREATURES',	'Both',		'EAMOD_CONJURATION',	'TECH_SORCERY',					NULL,	'SelfTowerTemple',	NULL,			'IsFallen',						3,					0,			1,				1,			'EA_SPELLS_ATLAS'	),
('EA_SPELL_SUMMON_DEMON',				'Both',		'EAMOD_CONJURATION',	'TECH_SUMMONING',				NULL,	'SelfTowerTemple',	NULL,			'IsFallen',						3,					0,			1,				1,			'EA_SPELLS_ATLAS'	),
('EA_SPELL_SUMMON_ARCHDEMON',			'Both',		'EAMOD_CONJURATION',	'TECH_BREACH',					NULL,	'SelfTowerTemple',	NULL,			'IsFallen',						15,					0,			1,				1,			'EA_SPELLS_ATLAS'	);
...
('EA_SPELL_CALL_HEAVENS_GUARD',			'Divine',	'EAMOD_CONJURATION',	'TECH_HEAVENLY_CYCLES',			NULL,	'SelfTowerTemple',	NULL,			'EA_SPELL_SUMMON_ABYSSAL_CREATURES', 3,				0,			1,				2,			'EA_SPELLS_ATLAS'	),
('EA_SPELL_CALL_ANGEL',					'Divine',	'EAMOD_CONJURATION',	'TECH_CELESTIAL_KNOWLEDGE',		NULL,	'SelfTowerTemple',	NULL,			'EA_SPELL_SUMMON_DEMON',		3,					0,			1,				2,			'EA_SPELLS_ATLAS'	),
('EA_SPELL_CALL_ARCHANGEL',				'Divine',	'EAMOD_CONJURATION',	'TECH_DIVINE_INTERVENTION',		NULL,	'SelfTowerTemple',	NULL,			'EA_SPELL_SUMMON_ARCHDEMON',	15,					0,			1,				2,			'EA_SPELLS_ATLAS'	),
...
('EA_SPELL_CALL_ANIMALS',				'Divine',	'EAMOD_CONJURATION',	'POLICY_FERAL_BOND',			NULL,	'SelfTowerTemple',	NULL,			NULL,							3,					0,			1,				2,			'EA_SPELLS_ATLAS'	),
('EA_SPELL_CALL_TREE_ENT',				'Divine',	'EAMOD_CONJURATION',	'POLICY_FOREST_DOMINION',		NULL,	'NearbyStrongWoods',NULL,			NULL,							3,					0,			1,				2,			'EA_SPELLS_ATLAS'	),
('EA_SPELL_CALL_MAJOR_SPIRIT',			'Divine',	'EAMOD_CONJURATION',	'POLICY_PANTHEISM_FINISHER',	NULL,	'SelfTowerTemple',	NULL,			NULL,							15,					0,			1,				2,			'EA_SPELLS_ATLAS'	);
...
('EA_SPELL_FAIR_WINDS',					'Divine',	'EAMOD_CONJURATION',	'RELIGION_CULT_OF_AEGIR',		NULL,	'OwnShips',			NULL,				1,					0,			1,				2,			'EA_SPELLS_ATLAS'	),
