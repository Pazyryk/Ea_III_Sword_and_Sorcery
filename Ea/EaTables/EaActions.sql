...
--Wonders
INSERT INTO EaActions (Type,			Description,								GPOnly,	TechReq,					UIType,		FinishXP,	AITarget,			GPClass,		GPSubclass,	OrGPSubclass,	City,	OwnCityRadius,	GPModType1,				TurnsToComplete,	ProgressHolder,	BuildType,					ImprovementType,					UniqueType,	EaWonder,						ReqEaWonder,					BuildingUnderConstruction,	Building,					BuildingMod,					IconIndex,	IconAtlas) VALUES
('EA_ACTION_KOLOSSOS',					'TXT_KEY_EA_ACTION_KOLOSSOS',				1,		'TECH_BRONZE_WORKING',		'Build',	100,		'OwnCities',		'Engineer',		NULL,		NULL,			'Own',	NULL,			'EAMOD_CONSTRUCTION',	25,					'City',			NULL,						NULL,								'World',	'EA_WONDER_KOLOSSOS',			NULL,							'BUILDING_KOLOSSOS',		'BUILDING_KOLOSSOS',		'BUILDING_KOLOSSOS_MOD',		4,			'BW_ATLAS_2'				),
('EA_ACTION_MEGALOS_FAROS',				'TXT_KEY_EA_ACTION_MEGALOS_FAROS',			1,		'TECH_SAILING',				'Build',	100,		'OwnCities',		'Engineer',		NULL,		NULL,			'Own',	NULL,			'EAMOD_CONSTRUCTION',	25,					'City',			NULL,						NULL,								'World',	'EA_WONDER_MEGALOS_FAROS',		NULL,							'BUILDING_MEGALOS_FAROS',	'BUILDING_MEGALOS_FAROS',	'BUILDING_MEGALOS_FAROS_MOD',	5,			'BW_ATLAS_2'				),
('EA_ACTION_HANGING_GARDENS',			'TXT_KEY_EA_ACTION_HANGING_GARDENS',		1,		'TECH_IRRIGATION',			'Build',	100,		'OwnCities',		'Engineer',		NULL,		NULL,			'Own',	NULL,			'EAMOD_CONSTRUCTION',	25,					'City',			NULL,						NULL,								'World',	'EA_WONDER_HANGING_GARDENS',	NULL,							'BUILDING_HANGING_GARDENS',	'BUILDING_HANGING_GARDENS',	'BUILDING_HANGING_GARDENS_MOD',	3,			'BW_ATLAS_2'				),
('EA_ACTION_UUC_YABNAL',				'TXT_KEY_EA_ACTION_UUC_YABNAL',				1,		'TECH_MASONRY',				'Build',	100,		'OwnCities',		'Engineer',		NULL,		NULL,			'Own',	NULL,			'EAMOD_CONSTRUCTION',	25,					'City',			NULL,						NULL,								'World',	'EA_WONDER_UUC_YABNAL',			NULL,							'BUILDING_UUC_YABNAL',		'BUILDING_UUC_YABNAL',		'BUILDING_UUC_YABNAL_MOD',		12,			'BW_ATLAS_2'				),
('EA_ACTION_THE_LONG_WALL',				'TXT_KEY_EA_ACTION_THE_LONG_WALL',			1,		'TECH_CONSTRUCTION',		'Build',	100,		'OwnCities',		'Engineer',		NULL,		NULL,			'Own',	NULL,			'EAMOD_CONSTRUCTION',	25,					'City',			NULL,						NULL,								'World',	'EA_WONDER_THE_LONG_WALL',		NULL,							'BUILDING_THE_LONG_WALL',	'BUILDING_THE_LONG_WALL',	'BUILDING_THE_LONG_WALL_MOD',	7,			'BW_ATLAS_2'				),
('EA_ACTION_CLOG_MOR',					'TXT_KEY_EA_ACTION_CLOG_MOR',				1,		'TECH_MACHINERY',			'Build',	100,		'OwnCities',		'Engineer',		NULL,		NULL,			'Own',	NULL,			'EAMOD_CONSTRUCTION',	25,					'City',			NULL,						NULL,								'World',	'EA_WONDER_CLOG_MOR',			NULL,							'BUILDING_CLOG_MOR',		'BUILDING_CLOG_MOR',		'BUILDING_CLOG_MOR_MOD',		19,			'BW_ATLAS_2'				),
('EA_ACTION_DA_BAOEN_SI',				'TXT_KEY_EA_ACTION_DA_BAOEN_SI',			1,		'TECH_ARCHITECTURE',		'Build',	100,		'OwnCities',		'Engineer',		NULL,		NULL,			'Own',	NULL,			'EAMOD_CONSTRUCTION',	25,					'City',			NULL,						NULL,								'World',	'EA_WONDER_DA_BAOEN_SI',		NULL,							'BUILDING_DA_BAOEN_SI',		'BUILDING_DA_BAOEN_SI',		'BUILDING_DA_BAOEN_SI_MOD',		16,			'BW_ATLAS_2'				),

('EA_ACTION_NATIONAL_TREASURY',			'TXT_KEY_EA_ACTION_NATIONAL_TREASURY',		1,		'TECH_COINAGE',				'Build',	100,		'OwnCities',		'Merchant',		NULL,		NULL,			'Own',	NULL,			'EAMOD_TRADE',			25,					'City',			NULL,						NULL,								'National',	NULL,							NULL,							NULL,						NULL,						'BUILDING_NATIONAL_TREASURY',	1,			'NEW_BLDG_ATLAS_DLC'		),

--plot wonders
('EA_ACTION_STANHENCG',					'TXT_KEY_EA_ACTION_STANHENCG',				1,		NULL,						'Build',	100,		'WonderWorkPlot',	'Devout',		'Druid',	NULL,			'Not',	NULL,			'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_STANHENCG',			'IMPROVEMENT_STANHENCG',			'World',	'EA_WONDER_STANHENCG',			NULL,							NULL,						NULL,						NULL,							2,			'BW_ATLAS_2'				),
('EA_ACTION_PYRAMID',					'TXT_KEY_EA_ACTION_PYRAMID',				1,		'TECH_MASONRY',				'Build',	100,		'WonderWorkPlot',	'Engineer',		NULL,		NULL,			'Not',	NULL,			'EAMOD_CONSTRUCTION',	25,					'Plot',			'BUILD_PYRAMID',			'IMPROVEMENT_PYRAMID',				'World',	'EA_WONDER_PYRAMID',			NULL,							NULL,						NULL,						NULL,							0,			'BW_ATLAS_2'				),
('EA_ACTION_GREAT_LIBRARY',				'TXT_KEY_EA_ACTION_GREAT_LIBRARY',			1,		'TECH_PHILOSOPHY',			'Build',	100,		'WonderWorkPlot',	'Sage',			NULL,		NULL,			'Not',	NULL,			'EAMOD_SCHOLARSHIP',	25,					'Plot',			'BUILD_GREAT_LIBRARY',		'IMPROVEMENT_GREAT_LIBRARY',		'World',	'EA_WONDER_GREAT_LIBRARY',		NULL,							NULL,						NULL,						NULL,							1,			'BW_ATLAS_2'				),
('EA_ACTION_ARCANE_TOWER',				'TXT_KEY_EA_ACTION_ARCANE_TOWER',			1,		'TECH_THAUMATURGY',			'Build',	100,		'WonderNoWorkPlot',	'Thaumaturge',	NULL,		NULL,			'Not',	1,				NULL,					25,					'Plot',			'BUILD_ARCANE_TOWER',		'IMPROVEMENT_ARCANE_TOWER',			NULL,		NULL,							NULL,							NULL,						NULL,						NULL,							3,			'UNIT_ACTION_ATLAS_EXP2'	),
('EA_ACTION_TEMPLE_AZZANDARA_1',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_1',		1,		'TECH_DIVINE_LITURGY',		'Build',	100,		'WonderWorkPlot',	'Devout',		'Priest',	'Paladin',		'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_1',	'IMPROVEMENT_TEMPLE_AZZANDARA_1',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_1',	NULL,							NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AZZANDARA_2',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_2',		1,		'TECH_DIVINE_VITALISM',		'Build',	100,		'WonderWorkPlot',	'Devout',		'Priest',	'Paladin',		'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_2',	'IMPROVEMENT_TEMPLE_AZZANDARA_2',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_2',	'EA_WONDER_TEMPLE_AZZANDARA_1',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AZZANDARA_3',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_3',		1,		'TECH_DIVINE_ESSENCE',		'Build',	100,		'WonderWorkPlot',	'Devout',		'Priest',	'Paladin',		'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_3',	'IMPROVEMENT_TEMPLE_AZZANDARA_3',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_3',	'EA_WONDER_TEMPLE_AZZANDARA_2',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AZZANDARA_4',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_4',		1,		'TECH_HEAVENLY_CYCLES',		'Build',	100,		'WonderWorkPlot',	'Devout',		'Priest',	'Paladin',		'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_4',	'IMPROVEMENT_TEMPLE_AZZANDARA_4',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_4',	'EA_WONDER_TEMPLE_AZZANDARA_3',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AZZANDARA_5',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_5',		1,		'TECH_CELESTIAL_KNOWLEDGE',	'Build',	100,		'WonderWorkPlot',	'Devout',		'Priest',	'Paladin',		'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_5',	'IMPROVEMENT_TEMPLE_AZZANDARA_5',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_5',	'EA_WONDER_TEMPLE_AZZANDARA_4',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AZZANDARA_6',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_6',		1,		'TECH_DIVINE_INTERVENTION',	'Build',	100,		'WonderWorkPlot',	'Devout',		'Priest',	'Paladin',		'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_6',	'IMPROVEMENT_TEMPLE_AZZANDARA_6',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_6',	'EA_WONDER_TEMPLE_AZZANDARA_5',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AZZANDARA_7',		'TXT_KEY_EA_ACTION_TEMPLE_AZZANDARA_7',		1,		'TECH_KNOWLEDGE_OF_HEAVEN',	'Build',	100,		'WonderWorkPlot',	'Devout',		'Priest',	'Paladin',		'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AZZANDARA_7',	'IMPROVEMENT_TEMPLE_AZZANDARA_7',	'World',	'EA_WONDER_TEMPLE_AZZANDARA_7',	'EA_WONDER_TEMPLE_AZZANDARA_6',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AHRIMAN_1',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_1',		1,		'TECH_MALEFICIUM',			'Build',	100,		'WonderWorkPlot',	'Devout',		'FallenPriest','Eidolon',	'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_1',	'IMPROVEMENT_TEMPLE_AHRIMAN_1',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_1',	NULL,							NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AHRIMAN_2',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_2',		1,		'TECH_REANIMATION',			'Build',	100,		'WonderWorkPlot',	'Devout',		'FallenPriest','Eidolon',	'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_2',	'IMPROVEMENT_TEMPLE_AHRIMAN_2',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_2',	'EA_WONDER_TEMPLE_AHRIMAN_1',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AHRIMAN_3',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_3',		1,		'TECH_SORCERY',				'Build',	100,		'WonderWorkPlot',	'Devout',		'FallenPriest','Eidolon',	'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_3',	'IMPROVEMENT_TEMPLE_AHRIMAN_3',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_3',	'EA_WONDER_TEMPLE_AHRIMAN_2',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AHRIMAN_4',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_4',		1,		'TECH_NECROMANCY',			'Build',	100,		'WonderWorkPlot',	'Devout',		'FallenPriest','Eidolon',	'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_4',	'IMPROVEMENT_TEMPLE_AHRIMAN_4',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_4',	'EA_WONDER_TEMPLE_AHRIMAN_3',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AHRIMAN_5',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_5',		1,		'TECH_SUMMONING',			'Build',	100,		'WonderWorkPlot',	'Devout',		'FallenPriest','Eidolon',	'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_5',	'IMPROVEMENT_TEMPLE_AHRIMAN_5',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_5',	'EA_WONDER_TEMPLE_AHRIMAN_4',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AHRIMAN_6',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_6',		1,		'TECH_SOUL_BINDING',		'Build',	100,		'WonderWorkPlot',	'Devout',		'FallenPriest','Eidolon',	'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_6',	'IMPROVEMENT_TEMPLE_AHRIMAN_6',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_6',	'EA_WONDER_TEMPLE_AHRIMAN_5',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AHRIMAN_7',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_7',		1,		'TECH_INVOCATION',			'Build',	100,		'WonderWorkPlot',	'Devout',		'FallenPriest','Eidolon',	'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_7',	'IMPROVEMENT_TEMPLE_AHRIMAN_7',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_7',	'EA_WONDER_TEMPLE_AHRIMAN_6',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AHRIMAN_8',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_8',		1,		'TECH_BREACH',				'Build',	100,		'WonderWorkPlot',	'Devout',		'FallenPriest','Eidolon',	'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_8',	'IMPROVEMENT_TEMPLE_AHRIMAN_8',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_8',	'EA_WONDER_TEMPLE_AHRIMAN_7',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	),
('EA_ACTION_TEMPLE_AHRIMAN_9',			'TXT_KEY_EA_ACTION_TEMPLE_AHRIMAN_9',		1,		'TECH_ARMAGEDDON_RITUALS',	'Build',	100,		'WonderWorkPlot',	'Devout',		'FallenPriest','Eidolon',	'Not',	1,				'EAMOD_DEVOTION',		25,					'Plot',			'BUILD_TEMPLE_AHRIMAN_9',	'IMPROVEMENT_TEMPLE_AHRIMAN_9',		'World',	'EA_WONDER_TEMPLE_AHRIMAN_9',	'EA_WONDER_TEMPLE_AHRIMAN_8',	NULL,						NULL,						NULL,							1,			'EXPANSION_TERRAIN_ATLAS'	);
