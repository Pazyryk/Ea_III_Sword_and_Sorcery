...
('EA_ARTIFACT_TOME_CORPUS_HERMETICUM',	'TXT_KEY_EA_ARTIFACT_TOME_CORPUS_HERMETICUM',	'Tome',		'EA_ACTION_TOME_CORPUS_HERMETICUM'		),
('EA_ARTIFACT_TOME_NECRONOMICON',		'TXT_KEY_EA_ARTIFACT_TOME_NECRONOMICON',		'Tome',		'EA_ACTION_TOME_NECRONOMICON'			),
('EA_ARTIFACT_TOME_ARS_GOETIA',			'TXT_KEY_EA_ARTIFACT_TOME_ARS_GOETIA',			'Tome',		'EA_ACTION_TOME_ARS_GOETIA'				),
('EA_ARTIFACT_TOME_BOOK_OF_EIBON',		'TXT_KEY_EA_ARTIFACT_TOME_BOOK_OF_EIBON',		'Tome',		'EA_ACTION_TOME_BOOK_OF_EIBON'			);
...
('EA_ARTIFACT_TOME_CORPUS_HERMETICUM',		'TECH_DIVINE_LITURGY',		-2		),
('EA_ARTIFACT_TOME_CORPUS_HERMETICUM',		'TECH_DIVINE_VITALISM',		-2		),
('EA_ARTIFACT_TOME_CORPUS_HERMETICUM',		'TECH_HEAVENLY_CYCLES',		-2		),
('EA_ARTIFACT_TOME_CORPUS_HERMETICUM',		'TECH_DIVINE_ESSENCE',		-2		),
('EA_ARTIFACT_TOME_CORPUS_HERMETICUM',		'TECH_CELESTIAL_KNOWLEDGE',	-2		),
('EA_ARTIFACT_TOME_CORPUS_HERMETICUM',		'TECH_DIVINE_INTERVENTION',	-2		),
('EA_ARTIFACT_TOME_CORPUS_HERMETICUM',		'TECH_KNOWLEDGE_OF_HEAVEN',	-2		),

('EA_ARTIFACT_TOME_NECRONOMICON',			'TECH_MALEFICIUM',			-2		),
('EA_ARTIFACT_TOME_NECRONOMICON',			'TECH_REANIMATION',			-2		),
--('EA_ARTIFACT_TOME_NECRONOMICON',			'TECH_VAMPIRISM',			-2		),
('EA_ARTIFACT_TOME_NECRONOMICON',			'TECH_NECROMANCY',			-2		),
('EA_ARTIFACT_TOME_NECRONOMICON',			'TECH_SOUL_BINDING',		-2		),
('EA_ARTIFACT_TOME_NECRONOMICON',			'TECH_ARMAGEDDON_RITUALS',	-2		),

('EA_ARTIFACT_TOME_ARS_GOETIA',				'TECH_MALEFICIUM',			-2		),
('EA_ARTIFACT_TOME_ARS_GOETIA',				'TECH_THAUMATURGY',			-2		),
--('EA_ARTIFACT_TOME_ARS_GOETIA',			'TECH_LYCANTHROPY',			-2		),
('EA_ARTIFACT_TOME_ARS_GOETIA',				'TECH_SORCERY',				-2		),
('EA_ARTIFACT_TOME_ARS_GOETIA',				'TECH_SUMMONING',			-2		),
('EA_ARTIFACT_TOME_ARS_GOETIA',				'TECH_BREACH',				-2		),
('EA_ARTIFACT_TOME_ARS_GOETIA',				'TECH_ARMAGEDDON_RITUALS',	-2		),

('EA_ARTIFACT_TOME_BOOK_OF_EIBON',			'TECH_THAUMATURGY',			-2		),
('EA_ARTIFACT_TOME_BOOK_OF_EIBON',			'TECH_CONJURATION',			-2		),
('EA_ARTIFACT_TOME_BOOK_OF_EIBON',			'TECH_TRANSMUTATION',		-2		),
('EA_ARTIFACT_TOME_BOOK_OF_EIBON',			'TECH_EVOCATION',			-2		),
('EA_ARTIFACT_TOME_BOOK_OF_EIBON',			'TECH_ABJURATION',			-2		),
--('EA_ARTIFACT_TOME_BOOK_OF_EIBON',			'TECH_ILLUSION',			-2		),
--('EA_ARTIFACT_TOME_BOOK_OF_EIBON',			'TECH_ENCHANTMENT',			-2		),
('EA_ARTIFACT_TOME_BOOK_OF_EIBON',			'TECH_INVOCATION',			-2		),
--('EA_ARTIFACT_TOME_BOOK_OF_EIBON',			'TECH_GREATER_ILLUSION',	-2		),
('EA_ARTIFACT_TOME_BOOK_OF_EIBON',			'TECH_GREATER_ARCANA',		-2		),
--('EA_ARTIFACT_TOME_BOOK_OF_EIBON',			'TECH_PHANTASMAGORIA',		-2		),
('EA_ARTIFACT_TOME_BOOK_OF_EIBON',			'TECH_ESOTERIC_ARCANA',		-2		);
